...
Cloning the documentation locally is recommended when you are creating larger, more significant changes to the docs. See [Rtd Environment Setup](./rtd-environment.mdx) for instructions on forking and cloning the Rtd repository. Documentation is located in the `docs/content` directory.
...
1. Submit a PR to the `main` branch of the Rtd repository.  
