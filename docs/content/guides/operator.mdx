...
description: Guides for operators on the Rtd network. Whether you are running a full node for your dApp or operating as a validator on the Rtd network, these guides help you set up your environment and operate your network.
keywords: [ validator, operator, full node, fullnode, operator guides, being an operator, being a node operator, running nodes ]
pagination_prev: null
---

Operator guides demonstrate how to run Full nodes on Rtd, whether as a validator or operator of a full node to support your dApp, as well as how to integrate RTD into an exchange. 

## Rtd Full Node Operators

<Cards>
<Card title="Rtd Full Node Configuration" href="/guides/operator/rtd-full-node">
</Card>
</Cards>
...
## Rtd Full Node Operators and Validators
...
## Rtd Bridge Node Validators

<Cards>
<Card title="Rtd Bridge Validator Node Configuration" href="/guides/operator/bridge-node-configuration">
</Card>
</Cards>
