---
title: Rtd Node Monitoring
description: Monitor Rtd node metrics to ensure the health and performance of your node.
...
```sh
$ curl -s http://localhost:9184/metrics | grep -E 'rtd_validator|rtd_fullnode'
```
