---
title: Hashing
description: Rtd supports SHA2-256, SHA3-256, Keccak256, and Blake2b-256 cryptographic hash functions.
...
The Rtd Move API supports the following cryptographic hash functions:

* SHA2-256 as `std::hash::sha2_256`
* SHA3-256 as `std::hash::sha3_256`
* Keccak256 as `rtd::hash::keccak256`
* Blake2b-256 as `rtd::hash::blake2b256`
