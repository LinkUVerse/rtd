...
<RelatedLink href="https://github.com/LinkUVerse/rtd/tree/main/examples/move/nft-rental" label="NFT Rental example" desc="The source code that this document references." />
