...
Usage: rtd client call [OPTIONS] --package <PACKAGE> --module <MODULE> --function <FUNCTION>
...
Options:
      ...
      --serialize-unsigned-transaction
          ...
          string can be used to execute transaction with `rtd client execute-signed-tx --tx-bytes
          <TX_BYTES>`
      ...
      --serialize-signed-transaction
          ...
          The string can be used to execute transaction with `rtd client execute-combined-signed-tx
