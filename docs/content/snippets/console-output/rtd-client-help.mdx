...
Usage: rtd client [OPTIONS] [COMMAND]
...
Commands:
  ...
  envs                        List all Rtd environments
  ...
  new-address                 Generate new address and keypair with keypair scheme flag {ed25519
                                  ...
                                  specified
  new-env                     Add new Rtd environment
  ...
  pay-all-rtd                 Pay all residual RTD coins to the recipient with input coins,
                                  after deducting the gas cost. The input coins also include the
                                  coin for gas payment, so no extra gas coin is required
  pay-rtd                     Pay RTD coins to recipients following following specified amounts,
  ...
  transfer-rtd                Transfer RTD, and pay gas with the same RTD coin object. If amount
...
Options:
      ...
      --client.env <ENV>        The Rtd environment to use. This must be present in the current
                                config file
