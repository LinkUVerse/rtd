...
- [x] If you plan to use the `--with-indexer` and `--with-graphql` options with `rtd start`, download and install **libpq-dev**:
  <div className="pl-8">
    ...
    See [Local Network](/guides/developer/rtd-101/local-network) for more information.
