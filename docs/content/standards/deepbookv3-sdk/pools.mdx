...
Input amounts, quantities, and prices should be provided in standard decimal format (e.g., `10.5` RTD, `0.00001` nBTC). The SDK handles conversion to base units internally. Returned amounts are also in standard decimal format.
:::
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="account" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="accountOpenOrders" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="checkManagerBalance" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getOrder" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getQuoteQuantityOut" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getBaseQuantityOut" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getQuantityOut" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getLevel2Range" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getLevel2TicksFromMid" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="lockedBalance" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="poolTradeParams" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="vaultBalances" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getPoolIdByAssets" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="midPrice" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="whitelisted" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="poolBookParams" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getOrders" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getPoolDeepPrice" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="addDeepPricePoint" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="updatePoolAllowedVersions" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="burnDeep" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="createPermissionlessPool" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getBalanceManagerIds" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="mintReferral" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="updateReferralMultiplier" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/deepbook.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="claimReferralRewards" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/client.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="getReferralBalances" signatureOnly />

## Related links

<RelatedLink
	href="https://github.com/LinkUVerse/ts-sdks/tree/main/packages/deepbook-v3"
	label="DeepBookV3 Indexer repository"
	desc="The DeepBookV3 SDK repository on GitHub."
/>
<RelatedLink
	href="https://www.npmjs.com/package/@linku/deepbook-v3"
	label="DeepBookV3 SDK node package"
	desc="The DeepBookV3 SDK node package on NPM."
/>
<RelatedLink
	href="https://github.com/LinkUVerse/deepbookv3"
