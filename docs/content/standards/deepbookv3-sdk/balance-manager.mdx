...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="createAndShareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="createBalanceManagerWithOwner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="createBalanceManagerWithOwnerAndCaps" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="shareBalanceManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="depositIntoManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="withdrawFromManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="withdrawAllFromManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="checkManagerBalance" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="generateProof" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="generateProofAsOwner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="generateProofAsTrader" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="mintTradeCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="mintDepositCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="mintWithdrawalCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="depositWithCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="withdrawWithCap" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="setReferral" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="unsetReferral" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="registerManager" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="owner" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="id" signatureOnly/>
...
<ImportContent source="packages/deepbook-v3/src/transactions/balanceManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="referralOwner" signatureOnly/>
...
// Example: Withdraw RTD from a balance manager
withdrawFunds = (tx: Transaction) => {
	const managerKey = 'MANAGER_1';
	const coinKey = 'RTD';
	const amount = 100; // 100 RTD
