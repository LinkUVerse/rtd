...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="createMarginPool" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="newProtocolConfig" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="newMarginPoolConfig" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="newInterestConfig" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="enableDeepbookPoolForLoan,disableDeepbookPoolForLoan" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="/packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="updateInterestParams" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginMaintainer.ts" mode="code" fun="updateMarginPoolConfig" org="LinkUVerse" repo="ts-sdks" signatureOnly />
...
```tsx
// Example: Allow RTD/USDC pool to borrow from USDC margin pool
enablePoolForBorrowing = (tx: Transaction) => {
	const deepbookPoolKey = 'RTD_DBUSDC';
	const coinKey = 'USDC';
...
setupNewMarginPool = (tx: Transaction) => {
	...
	tx.add(this.maintainerContract.enableDeepbookPoolForLoan('RTD_DBUSDC', coinKey, marginPoolCapId));
	tx.add(this.maintainerContract.enableDeepbookPoolForLoan('RTD_USDT', coinKey, marginPoolCapId));
};
```
