...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="newMarginManager" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="newMarginManagerWithInitializer" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="shareMarginManager" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="depositBase,depositQuote,depositDeep" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="withdrawBase,withdrawQuote,withdrawDeep" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="borrowBase,borrowBase" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="repayBase,repayQuote" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="liquidate" signatureOnly />
...
<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="ownerByPoolKey,deepbookPool,marginPoolId" signatureOnly />

### `borrowedShares`, `borrowedBaseShares`, `borrowedQuoteShares`, `hasBaseDebt`

Query borrowed position information.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="borrowedShares,borrowedBaseShares,borrowedQuoteShares,hasBaseDebt" signatureOnly />

### `balanceManager`, `calculateAssets`, `calculateDebts`

Query balance and debt information.

<ImportContent source="packages/deepbook-v3/src/transactions/marginManager.ts" mode="code" org="LinkUVerse" repo="ts-sdks" fun="balanceManager,calculateAssets,calculateDebts" signatureOnly />
...
```tsx
// Example: Deposit 100 RTD as collateral
...
<RelatedLink
	href="https://github.com/LinkUVerse/deepbookv3/tree/main/packages/deepbook_margin"
