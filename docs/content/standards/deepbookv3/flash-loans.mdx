...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="LinkUVerse" repo="deepbookv3" fun="borrow_flashloan_base" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="LinkUVerse" repo="deepbookv3" fun="borrow_flashloan_quote" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="LinkUVerse" repo="deepbookv3" fun="return_flashloan_base" noComments />
...
<ImportContent source="packages/deepbook/sources/pool.move" mode="code" org="LinkUVerse" repo="deepbookv3" fun="return_flashloan_quote" noComments />
