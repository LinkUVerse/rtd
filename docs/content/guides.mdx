...
description: Start developing on Rtd through example projects and developer guides.
keywords: [ developer guides, get started, operator guides, rtdplayx01 guides, rtd 101, coins, tokens, nfts ]
---

This section provides practical, implementation-focused examples designed to accelerate your journey developing on Rtd. 

Whether you are new to blockchain development or an experienced Rtd developer, these resources offer structured guidance for building applications, creating assets, and leveraging Rtd's unique technical features effectively.

## Get started developing on Rtd

Install tooling, setup your environment, and deploy a "Hello, World!" Move package to start your Rtd developer experience. 

<Cards>
<Card className="plausible-event-name=guides+install+button" title="1. Install Rtd" href="/guides/developer/getting-started/rtd-install" />
<Card className="plausible-event-name=guides+client+button" title="2. Configure a Rtd Client" href="/guides/developer/getting-started/configure-rtd-client" />
<Card className="plausible-event-name=guides+address+button" title="3. Create a Rtd Address" href="/guides/developer/getting-started/get-address" />
<Card className="plausible-event-name=guides+faucet+button" title="4. Get RTD from Faucet" href="/guides/developer/getting-started/get-coins" />
...
Learn how to mint coins and tokens on Rtd.
...
<Cards>
<Card title="Rtd On-Chain Signatures Verification in Move" href="/guides/developer/cryptography/signing" />
...
Try out these example applications to learn more about Rtd.
...
## Validating and operating nodes on Rtd

Processes and guides for validators and node operators on the Rtd network.

<Cards>
<Card title="Validator Configuration" href="/guides/operator/validator/validator-config" />
<Card title="Run a Rtd Full Node" href="/guides/operator/rtd-full-node" />
<Card title="Full Node Data Management" href="/guides/operator/data-management"/>
<Card title="Rtd Bridge Node Configuration" href="/guides/operator/bridge-node-configuration" />
</Cards>
