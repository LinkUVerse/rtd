...
const Property = (props) => {
  ...
  return (
    <div
      className={`grid grid-cols-6 ml-4 even:bg-rtd-ghost-white dark:even:bg-rtd-ghost-dark`}
    >
...
const Result = (props) => {
  ...
  return (
    <div className="ml-4 p-4 text-rtd-gray-80 dark:text-rtd-gray-50 border dark:border-rtd-gray-75 rounded-lg bg-rtd-ghost-white dark:bg-rtd-ghost-dark">
      <p className="font-bold">
        <PropType proptype={[result.name, result.schema]}></PropType>
      </p>

      {hasDesc && !hasRef && (
        <p className="ml-4 p-2 text-rtd-gray-100 dark:text-rtd-gray-50 rounded-lg">
      ...
      {hasRef && hasRefProps && (
        <div className="border-b pb-4">
          <p className="font-bold mt-6 mb-2 ml-4 text-rtd-gray-80 dark:text-rtd-gray-50">
            Properties
          </p>
          <div className={`grid grid-cols-6 ml-4 pb-2`}>
            ...
            <div className="p-2 bg-rtd-blue dark:bg-rtd-blue-dark text-rtd-gray-95 dark:text-rtd-gray-50 font-bold">
              Required
            </div>
            <div className="rounded-tr-lg rounded-br-lg col-span-3 p-2 bg-rtd-blue dark:bg-rtd-blue-dark text-rtd-gray-95 dark:text-rtd-gray-50 font-bold">
              Description
            </div>
          </div>
