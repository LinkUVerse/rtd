---
title: Module `rtd::derived_object`
---
...
-  [Struct `Claimed`](#rtd_derived_object_Claimed)
-  [Struct `DerivedObjectKey`](#rtd_derived_object_DerivedObjectKey)
-  [Enum `ClaimedStatus`](#rtd_derived_object_ClaimedStatus)
-  [Constants](#@Constants_0)
-  [Function `claim`](#rtd_derived_object_claim)
-  [Function `exists`](#rtd_derived_object_exists)
-  [Function `derive_address`](#rtd_derived_object_derive_address)
...
<a name="rtd_derived_object_Claimed"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd/derived_object.md#rtd_derived_object_Claimed">Claimed</a> <b>has</b> <b>copy</b>, drop, store
</code></pre>
...
<a name="rtd_derived_object_DerivedObjectKey"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd/derived_object.md#rtd_derived_object_DerivedObjectKey">DerivedObjectKey</a>&lt;K: <b>copy</b>, drop, store&gt; <b>has</b> <b>copy</b>, drop, store
</code></pre>
...
<a name="rtd_derived_object_ClaimedStatus"></a>
...
<pre><code><b>public</b> <b>enum</b> <a href="../rtd/derived_object.md#rtd_derived_object_ClaimedStatus">ClaimedStatus</a> <b>has</b> store
</code></pre>
...
<a name="rtd_derived_object_EObjectAlreadyExists"></a>

Tries to create an object twice with the same parent-key combination.


<pre><code>#[error]
<b>const</b> <a href="../rtd/derived_object.md#rtd_derived_object_EObjectAlreadyExists">EObjectAlreadyExists</a>: vector&lt;u8&gt; = b"Derived <a href="../rtd/object.md#rtd_object">object</a> is already claimed.";
</code></pre>



<a name="rtd_derived_object_claim"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd/derived_object.md#rtd_derived_object_claim">claim</a>&lt;K: <b>copy</b>, drop, store&gt;(parent: &<b>mut</b> <a href="../rtd/object.md#rtd_object_UID">rtd::object::UID</a>, key: K): <a href="../rtd/object.md#rtd_object_UID">rtd::object::UID</a>
</code></pre>
...
<a name="rtd_derived_object_exists"></a>

## Function `exists`

Checks if a provided <code>key</code> has been claimed for the given parent.
Note: If the UID has been deleted through <code><a href="../rtd/object.md#rtd_object_delete">object::delete</a></code>, this will always return true.


<pre><code><b>public</b> <b>fun</b> <a href="../rtd/derived_object.md#rtd_derived_object_exists">exists</a>&lt;K: <b>copy</b>, drop, store&gt;(parent: &<a href="../rtd/object.md#rtd_object_UID">rtd::object::UID</a>, key: K): bool
</code></pre>
...
<a name="rtd_derived_object_derive_address"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd/derived_object.md#rtd_derived_object_derive_address">derive_address</a>&lt;K: <b>copy</b>, drop, store&gt;(parent: <a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>, key: K): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd/derived_object.md#rtd_derived_object_derive_address">derive_address</a>&lt;K: <b>copy</b> + drop + store&gt;(parent: ID, key: K): <b>address</b> {
    df::hash_type_and_key(parent.to_address(), <a href="../rtd/derived_object.md#rtd_derived_object_DerivedObjectKey">DerivedObjectKey</a>(key))
}
</code></pre>
