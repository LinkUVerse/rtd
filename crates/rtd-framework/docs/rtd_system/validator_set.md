---
title: Module `rtd_system::validator_set`
---



-  [Struct `ValidatorSet`](#rtd_system_validator_set_ValidatorSet)
-  [Struct `ValidatorEpochInfoEvent`](#rtd_system_validator_set_ValidatorEpochInfoEvent)
-  [Struct `ValidatorEpochInfoEventV2`](#rtd_system_validator_set_ValidatorEpochInfoEventV2)
-  [Struct `ValidatorJoinEvent`](#rtd_system_validator_set_ValidatorJoinEvent)
-  [Struct `ValidatorLeaveEvent`](#rtd_system_validator_set_ValidatorLeaveEvent)
-  [Struct `VotingPowerAdmissionStartEpochKey`](#rtd_system_validator_set_VotingPowerAdmissionStartEpochKey)
-  [Constants](#@Constants_0)
-  [Function `new`](#rtd_system_validator_set_new)
-  [Function `request_add_validator_candidate`](#rtd_system_validator_set_request_add_validator_candidate)
-  [Function `request_remove_validator_candidate`](#rtd_system_validator_set_request_remove_validator_candidate)
-  [Function `request_add_validator`](#rtd_system_validator_set_request_add_validator)
-  [Function `can_join`](#rtd_system_validator_set_can_join)
-  [Function `get_voting_power_thresholds`](#rtd_system_validator_set_get_voting_power_thresholds)
-  [Function `assert_no_pending_or_active_duplicates`](#rtd_system_validator_set_assert_no_pending_or_active_duplicates)
-  [Function `request_remove_validator`](#rtd_system_validator_set_request_remove_validator)
-  [Function `request_add_stake`](#rtd_system_validator_set_request_add_stake)
...
-  [Function `validator_stake_amount`](#rtd_system_validator_set_validator_stake_amount)
-  [Function `validator_voting_power`](#rtd_system_validator_set_validator_voting_power)
-  [Function `validator_staking_pool_id`](#rtd_system_validator_set_validator_staking_pool_id)
-  [Function `staking_pool_mappings`](#rtd_system_validator_set_staking_pool_mappings)
-  [Function `validator_address_by_pool_id`](#rtd_system_validator_set_validator_address_by_pool_id)
-  [Function `pool_exchange_rates`](#rtd_system_validator_set_pool_exchange_rates)
-  [Function `validator_by_pool_id`](#rtd_system_validator_set_validator_by_pool_id)
...
-  [Function `compute_adjusted_reward_distribution`](#rtd_system_validator_set_compute_adjusted_reward_distribution)
-  [Function `distribute_reward`](#rtd_system_validator_set_distribute_reward)
-  [Function `emit_validator_epoch_events`](#rtd_system_validator_set_emit_validator_epoch_events)
-  [Function `sum_voting_power_by_addresses`](#rtd_system_validator_set_sum_voting_power_by_addresses)
-  [Function `active_validators`](#rtd_system_validator_set_active_validators)
-  [Function `is_validator_candidate`](#rtd_system_validator_set_is_validator_candidate)
-  [Function `is_active_validator`](#rtd_system_validator_set_is_active_validator)
-  [Function `is_inactive_validator`](#rtd_system_validator_set_is_inactive_validator)
...
<a name="rtd_system_validator_set_ValidatorSet"></a>

## Struct `ValidatorSet`



<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a> <b>has</b> store
</code></pre>
...
<dl>
<dt>
<code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>: u64</code>
</dt>
<dd>
 Total amount of stake from all active validators at the beginning of the epoch.
 Written only once per epoch, in <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_advance_epoch">advance_epoch</a></code> function.
</dd>
<dt>
<code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>: vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;</code>
</dt>
<dd>
 The current list of active validators.
</dd>
<dt>
<code>pending_active_validators: <a href="../rtd/table_vec.md#rtd_table_vec_TableVec">rtd::table_vec::TableVec</a>&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;</code>
</dt>
<dd>
...
<dd>
 ...
 pointing to <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a></code>.
</dd>
<dt>
<code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>: <a href="../rtd/table.md#rtd_table_Table">rtd::table::Table</a>&lt;<a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>, <b>address</b>&gt;</code>
</dt>
<dd>
 Mappings from staking pool's ID to the rtd address of a validator.
</dd>
<dt>
<code>inactive_validators: <a href="../rtd/table.md#rtd_table_Table">rtd::table::Table</a>&lt;<a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>, <a href="../rtd_system/validator_wrapper.md#rtd_system_validator_wrapper_ValidatorWrapper">rtd_system::validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
 Mapping from a staking pool ID to the inactive validator that has that pool as its staking pool.
 When a validator is deactivated the validator is removed from <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a></code> it
 is added to this table so that stakers can continue to withdraw their stake from it.
</dd>
<dt>
<code>validator_candidates: <a href="../rtd/table.md#rtd_table_Table">rtd::table::Table</a>&lt;<b>address</b>, <a href="../rtd_system/validator_wrapper.md#rtd_system_validator_wrapper_ValidatorWrapper">rtd_system::validator_wrapper::ValidatorWrapper</a>&gt;</code>
</dt>
<dd>
 Table storing preactive/candidate validators, mapping their addresses to their <code>Validator </code> structs.
 When an address calls <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_validator_candidate">request_add_validator_candidate</a></code>, they get added to this table and become a preactive
 validator.
 When the candidate has met the min stake requirement, they can call <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_validator">request_add_validator</a></code> to
 officially add them to the active validator set <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a></code> next epoch.
</dd>
<dt>
<code>at_risk_validators: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, u64&gt;</code>
</dt>
<dd>
...
<a name="rtd_system_validator_set_ValidatorEpochInfoEvent"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorEpochInfoEvent">ValidatorEpochInfoEvent</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<dt>
<code>pool_token_exchange_rate: <a href="../rtd_system/staking_pool.md#rtd_system_staking_pool_PoolTokenExchangeRate">rtd_system::staking_pool::PoolTokenExchangeRate</a></code>
</dt>
<dd>
</dd>
<dt>
...
<a name="rtd_system_validator_set_ValidatorEpochInfoEventV2"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorEpochInfoEventV2">ValidatorEpochInfoEventV2</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<a name="rtd_system_validator_set_ValidatorJoinEvent"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorJoinEvent">ValidatorJoinEvent</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<dt>
<code>staking_pool_id: <a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a></code>
</dt>
<dd>
</dd>
</dl>
...
<a name="rtd_system_validator_set_ValidatorLeaveEvent"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorLeaveEvent">ValidatorLeaveEvent</a> <b>has</b> <b>copy</b>, drop
</code></pre>
...
<a name="rtd_system_validator_set_VotingPowerAdmissionStartEpochKey"></a>
...
<pre><code><b>public</b> <b>struct</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_VotingPowerAdmissionStartEpochKey">VotingPowerAdmissionStartEpochKey</a> <b>has</b> <b>copy</b>, drop, store
</code></pre>
...
<a name="rtd_system_validator_set_ENonValidatorInReportRecords"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENonValidatorInReportRecords">ENonValidatorInReportRecords</a>: u64 = 0;
</code></pre>



<a name="rtd_system_validator_set_EInvalidStakeAdjustmentAmount"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EInvalidStakeAdjustmentAmount">EInvalidStakeAdjustmentAmount</a>: u64 = 1;
</code></pre>



<a name="rtd_system_validator_set_EDuplicateValidator"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EDuplicateValidator">EDuplicateValidator</a>: u64 = 2;
</code></pre>



<a name="rtd_system_validator_set_ENoPoolFound"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENoPoolFound">ENoPoolFound</a>: u64 = 3;
</code></pre>



<a name="rtd_system_validator_set_ENotAValidator"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotAValidator">ENotAValidator</a>: u64 = 4;
</code></pre>



<a name="rtd_system_validator_set_EMinJoiningStakeNotReached"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EMinJoiningStakeNotReached">EMinJoiningStakeNotReached</a>: u64 = 5;
</code></pre>



<a name="rtd_system_validator_set_EAlreadyValidatorCandidate"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EAlreadyValidatorCandidate">EAlreadyValidatorCandidate</a>: u64 = 6;
</code></pre>



<a name="rtd_system_validator_set_EValidatorNotCandidate"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorNotCandidate">EValidatorNotCandidate</a>: u64 = 7;
</code></pre>



<a name="rtd_system_validator_set_ENotValidatorCandidate"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotValidatorCandidate">ENotValidatorCandidate</a>: u64 = 8;
</code></pre>
...
<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EStakingBelowThreshold">EStakingBelowThreshold</a>: u64 = 10;
</code></pre>



<a name="rtd_system_validator_set_EValidatorAlreadyRemoved"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorAlreadyRemoved">EValidatorAlreadyRemoved</a>: u64 = 11;
</code></pre>



<a name="rtd_system_validator_set_ENotAPendingValidator"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotAPendingValidator">ENotAPendingValidator</a>: u64 = 12;
</code></pre>



<a name="rtd_system_validator_set_EValidatorSetEmpty"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorSetEmpty">EValidatorSetEmpty</a>: u64 = 13;
</code></pre>



<a name="rtd_system_validator_set_EInvalidCap"></a>
...
<a name="rtd_system_validator_set_ACTIVE_VALIDATOR_ONLY"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ACTIVE_VALIDATOR_ONLY">ACTIVE_VALIDATOR_ONLY</a>: u8 = 1;
</code></pre>



<a name="rtd_system_validator_set_ACTIVE_OR_PENDING_VALIDATOR"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ACTIVE_OR_PENDING_VALIDATOR">ACTIVE_OR_PENDING_VALIDATOR</a>: u8 = 2;
</code></pre>
...
<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ANY_VALIDATOR">ANY_VALIDATOR</a>: u8 = 3;
</code></pre>



<a name="rtd_system_validator_set_BASIS_POINT_DENOMINATOR"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>: u64 = 10000;
</code></pre>



<a name="rtd_system_validator_set_MIN_STAKING_THRESHOLD"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_MIN_STAKING_THRESHOLD">MIN_STAKING_THRESHOLD</a>: u64 = 1000000000;
</code></pre>



<a name="rtd_system_validator_set_PHASE_LENGTH"></a>



<pre><code><b>const</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_PHASE_LENGTH">PHASE_LENGTH</a>: u64 = 14;
</code></pre>



<a name="rtd_system_validator_set_new"></a>

## Function `new`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_new">new</a>(init_active_validators: vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_new">new</a>(
    init_active_validators: vector&lt;Validator&gt;,
    ctx: &<b>mut</b> TxContext,
): <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a> {
    <b>let</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a> = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_calculate_total_stakes">calculate_total_stakes</a>(&init_active_validators);
    <b>let</b> <b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a> = table::new(ctx);
    init_active_validators.do_ref!(|v| {
        <a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.add(v.staking_pool_id(), v.rtd_address());
    });
    <b>let</b> <b>mut</b> validators = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a> {
        <a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>,
        <a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>: init_active_validators,
        pending_active_validators: table_vec::empty(ctx),
        pending_removals: vector[],
        <a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>,
        inactive_validators: table::new(ctx),
        validator_candidates: table::new(ctx),
        at_risk_validators: vec_map::empty(),
        extra_fields: bag::new(ctx),
    };
    <a href="../rtd_system/voting_power.md#rtd_system_voting_power_set_voting_power">voting_power::set_voting_power</a>(&<b>mut</b> validators.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>, <a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>);
    validators
}
</code></pre>
...
<a name="rtd_system_validator_set_request_add_validator_candidate"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_validator_candidate">request_add_validator_candidate</a>(
    ...
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.add(<a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.staking_pool_id(), validator_address);
...
<a name="rtd_system_validator_set_request_remove_validator_candidate"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_remove_validator_candidate">request_remove_validator_candidate</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    ctx: &<b>mut</b> TxContext,
) {
    ...
    <b>let</b> <b>mut</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = self.validator_candidates.remove(validator_address).destroy();
    <b>assert</b>!(<a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.is_preactive(), <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorNotCandidate">EValidatorNotCandidate</a>);
    <b>let</b> staking_pool_id = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.staking_pool_id();
    // Remove the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>'s staking pool from mappings.
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.remove(staking_pool_id);
    // Deactivate the staking pool.
    <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.deactivate(ctx.epoch());
    // Add to the inactive tables.
    self.inactive_validators.add(staking_pool_id, <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.wrap_v1(ctx));
}
</code></pre>
...
<a name="rtd_system_validator_set_request_add_validator"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_validator">request_add_validator</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, ctx: &TxContext) {
    <b>let</b> validator_address = ctx.sender();
    <b>assert</b>!(self.validator_candidates.contains(validator_address), <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotValidatorCandidate">ENotValidatorCandidate</a>);
...
<a name="rtd_system_validator_set_can_join"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_can_join">can_join</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, stake: u64, ctx: &<a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): bool
</code></pre>
...
<a name="rtd_system_validator_set_get_voting_power_thresholds"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_voting_power_thresholds">get_voting_power_thresholds</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, ctx: &<a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): (u64, u64, u64)
</code></pre>
...
<a name="rtd_system_validator_set_assert_no_pending_or_active_duplicates"></a>

## Function `assert_no_pending_or_active_duplicates`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_assert_no_pending_or_active_duplicates">assert_no_pending_or_active_duplicates</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>: &<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_assert_no_pending_or_active_duplicates">assert_no_pending_or_active_duplicates</a>(
...
<a name="rtd_system_validator_set_request_remove_validator"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_remove_validator">request_remove_validator</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, ctx: &<a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_remove_validator">request_remove_validator</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, ctx: &TxContext) {
    <b>let</b> validator_address = ctx.sender();
    <b>let</b> validator_index = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(
        &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
        validator_address,
    ).destroy_or!(<b>abort</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotAValidator">ENotAValidator</a>);
    <b>assert</b>!(!self.pending_removals.contains(&validator_index), <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorAlreadyRemoved">EValidatorAlreadyRemoved</a>);
...
<a name="rtd_system_validator_set_request_add_stake"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_stake">request_add_stake</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>, stake: <a href="../rtd/balance.md#rtd_balance_Balance">rtd::balance::Balance</a>&lt;<a href="../rtd/rtd.md#rtd_rtd_RTD">rtd::rtd::RTD</a>&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd_system/staking_pool.md#rtd_system_staking_pool_StakedRtd">rtd_system::staking_pool::StakedRtd</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_stake">request_add_stake</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
    stake: Balance&lt;RTD&gt;,
    ctx: &<b>mut</b> TxContext,
): StakedRtd {
    <b>let</b> rtd_amount = stake.value();
    <b>assert</b>!(rtd_amount &gt;= <a href="../rtd_system/validator_set.md#rtd_system_validator_set_MIN_STAKING_THRESHOLD">MIN_STAKING_THRESHOLD</a>, <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EStakingBelowThreshold">EStakingBelowThreshold</a>);
    self
        .<a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(validator_address)
        .<a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_stake">request_add_stake</a>(stake, ctx.sender(), ctx)
}
</code></pre>
...
<a name="rtd_system_validator_set_request_withdraw_stake"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_withdraw_stake">request_withdraw_stake</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    staked_rtd: StakedRtd,
    ctx: &TxContext,
): Balance&lt;RTD&gt; {
    <b>let</b> staking_pool_id = staked_rtd.pool_id();
    <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = <b>if</b> (self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.contains(staking_pool_id)) {
        // This is an active <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.
        <b>let</b> validator_address = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>[staked_rtd.pool_id()];
        self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(validator_address)
    } <b>else</b> {
        // This is an inactive pool.
        <b>assert</b>!(self.inactive_validators.contains(staking_pool_id), <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENoPoolFound">ENoPoolFound</a>);
        self.inactive_validators[staking_pool_id].load_validator_maybe_upgrade()
    };
    <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_withdraw_stake">request_withdraw_stake</a>(staked_rtd, ctx)
}
</code></pre>
...
<a name="rtd_system_validator_set_convert_to_fungible_staked_rtd"></a>

## Function `convert_to_fungible_staked_rtd`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_convert_to_fungible_staked_rtd">convert_to_fungible_staked_rtd</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, staked_rtd: <a href="../rtd_system/staking_pool.md#rtd_system_staking_pool_StakedRtd">rtd_system::staking_pool::StakedRtd</a>, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd_system/staking_pool.md#rtd_system_staking_pool_FungibleStakedRtd">rtd_system::staking_pool::FungibleStakedRtd</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_convert_to_fungible_staked_rtd">convert_to_fungible_staked_rtd</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    staked_rtd: StakedRtd,
    ctx: &<b>mut</b> TxContext,
): FungibleStakedRtd {
    ...
    <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = <b>if</b> (self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.contains(staking_pool_id)) {
        // This is an active <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.
        <b>let</b> validator_address = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>[staking_pool_id];
        self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(validator_address)
    } <b>else</b> {
        // This is an inactive pool.
        <b>assert</b>!(self.inactive_validators.contains(staking_pool_id), <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENoPoolFound">ENoPoolFound</a>);
    ...
    <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_convert_to_fungible_staked_rtd">convert_to_fungible_staked_rtd</a>(staked_rtd, ctx)
}
</code></pre>
...
<a name="rtd_system_validator_set_redeem_fungible_staked_rtd"></a>

## Function `redeem_fungible_staked_rtd`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_redeem_fungible_staked_rtd">redeem_fungible_staked_rtd</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, fungible_staked_rtd: <a href="../rtd_system/staking_pool.md#rtd_system_staking_pool_FungibleStakedRtd">rtd_system::staking_pool::FungibleStakedRtd</a>, ctx: &<a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd/balance.md#rtd_balance_Balance">rtd::balance::Balance</a>&lt;<a href="../rtd/rtd.md#rtd_rtd_RTD">rtd::rtd::RTD</a>&gt;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_redeem_fungible_staked_rtd">redeem_fungible_staked_rtd</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    fungible_staked_rtd: FungibleStakedRtd,
    ctx: &TxContext,
): Balance&lt;RTD&gt; {
    <b>let</b> staking_pool_id = fungible_staked_rtd.pool_id();
    <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = <b>if</b> (self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.contains(staking_pool_id)) {
        // This is an active <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.
        <b>let</b> validator_address = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>[staking_pool_id];
        self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(validator_address)
    ...
    <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_redeem_fungible_staked_rtd">redeem_fungible_staked_rtd</a>(fungible_staked_rtd, ctx)
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_advance_epoch">advance_epoch</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    computation_reward: &<b>mut</b> Balance&lt;RTD&gt;,
    storage_fund_reward: &<b>mut</b> Balance&lt;RTD&gt;,
    ...
    <b>let</b> total_voting_power = <a href="../rtd_system/voting_power.md#rtd_system_voting_power_total_voting_power">voting_power::total_voting_power</a>();
    ...
    ) = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
        &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
        total_voting_power,
    ...
    // punished.
    <b>let</b> slashed_validators = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_slashed_validators">compute_slashed_validators</a>(*validator_report_records);
    <b>let</b> total_slashed_validator_voting_power = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(
        &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
        &slashed_validators,
    );
    ...
    ) = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(
        <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_indices">get_validator_indices</a>(&self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>, &slashed_validators),
    ...
    ) = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(
        &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
        total_voting_power,
    ...
    <a href="../rtd_system/validator_set.md#rtd_system_validator_set_distribute_reward">distribute_reward</a>(
        &<b>mut</b> self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
        &adjusted_staking_reward_amounts,
        &adjusted_storage_fund_reward_amounts,
        computation_reward,
        storage_fund_reward,
    ...
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_pending_removals">process_pending_removals</a>(validator_report_records, ctx);
    // kick low stake validators out.
    <b>let</b> new_total_stake = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_update_validator_positions_and_calculate_total_stake">update_validator_positions_and_calculate_total_stake</a>(
        low_stake_grace_period,
        validator_report_records,
        ctx,
    );
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a> = new_total_stake;
...
<a name="rtd_system_validator_set_update_validator_positions_and_calculate_total_stake"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_update_validator_positions_and_calculate_total_stake">update_validator_positions_and_calculate_total_stake</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, low_stake_grace_period: u64, validator_report_records: &<b>mut</b> <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_update_validator_positions_and_calculate_total_stake">update_validator_positions_and_calculate_total_stake</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    low_stake_grace_period: u64,
    validator_report_records: &<b>mut</b> VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
    ctx: &<b>mut</b> TxContext,
    ...
    <b>let</b> pending_total_stake = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_calculate_total_stakes">calculate_total_stakes</a>(&pending_active_validators);
    <b>let</b> initial_total_stake = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_calculate_total_stakes">calculate_total_stakes</a>(&self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>) + pending_total_stake;
    <b>let</b> (
        min_joining_voting_power_threshold,
        low_voting_power_threshold,
        very_low_voting_power_threshold,
    ) = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_voting_power_thresholds">get_voting_power_thresholds</a>(ctx);
    ...
    <b>let</b> <b>mut</b> i = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.length();
    <b>while</b> (i &gt; 0) {
        i = i - 1;
        <b>let</b> validator_ref = &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>[i];
        <b>let</b> validator_address = validator_ref.rtd_address();
        <b>let</b> validator_stake = validator_ref.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>();
        // calculate the voting power <b>for</b> this <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> in the next epoch <b>if</b> no validators are removed
        // <b>if</b> one of more low stake validators are removed, it's possible this <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> will have higher voting power--that's ok.
        <b>let</b> <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> = <a href="../rtd_system/voting_power.md#rtd_system_voting_power_derive_raw_voting_power">voting_power::derive_raw_voting_power</a>(
            validator_stake,
            initial_total_stake,
        );
        // SIP-39: a <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> can remain indefinitely with a voting power ≥ LOW_VOTING_POWER_THRESHOLD
        <b>if</b> (<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> &gt;= low_voting_power_threshold) {
            // The <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> is safe. We remove their <b>entry</b> from the at_risk map <b>if</b> there exists one.
            <b>if</b> (self.at_risk_validators.contains(&validator_address)) {
                self.at_risk_validators.remove(&validator_address);
            }
            // SIP-39: <b>as</b> soon <b>as</b> the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>’s voting power falls to VERY_LOW_VOTING_POWER_THRESHOLD,
            //      they are on probation and must acquire sufficient stake to recover to voting power
        } <b>else</b> <b>if</b> (<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> &gt;= very_low_voting_power_threshold) {
            // The stake is a bit below the threshold so we increment the <b>entry</b> of the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> in the map.
            ...
            // If the grace period <b>has</b> passed, the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> <b>has</b> to leave us.
            <b>if</b> (new_low_stake_period &gt; low_stake_grace_period) {
                <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.remove(i);
                <b>let</b> removed_stake = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_validator_departure">process_validator_departure</a>(
                    <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>,
                    validator_report_records,
                    <b>false</b>, // the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> is kicked out involuntarily
                    ctx,
                );
                total_removed_stake = total_removed_stake + removed_stake;
            }
            // SIP-39: at the end of an epoch when <a href="../rtd_system/validator_set.md#rtd_system_validator_set_new">new</a> voting powers are computed based on stake changes,
            //      any <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> with VOTING_POWER &lt; VERY_LOW_VOTING_POWER_THRESHOLD will be removed
        } <b>else</b> {
            // The <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>'s stake is lower than the very low threshold so we kick them out immediately.
            <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.remove(i);
            <b>let</b> removed_stake = self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_validator_departure">process_validator_departure</a>(
                <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>,
                validator_report_records,
    ...
    // the time of <a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_validator">request_add_validator</a>, but stake may have been withdrawn, or stakes of other
    // validators may have increased significantly
    pending_active_validators.do!(|<b>mut</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>| {
        <b>let</b> validator_stake = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>();
        <b>let</b> <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> = <a href="../rtd_system/voting_power.md#rtd_system_voting_power_derive_raw_voting_power">voting_power::derive_raw_voting_power</a>(
            validator_stake,
            initial_total_stake,
        );
        <b>if</b> (<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> &gt;= min_joining_voting_power_threshold) {
            <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.activate(ctx.epoch());
            event::emit(<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorJoinEvent">ValidatorJoinEvent</a> {
                epoch: ctx.epoch(),
                validator_address: <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.rtd_address(),
                staking_pool_id: <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.staking_pool_id(),
            });
            self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.push_back(<a href="../rtd_system/validator.md#rtd_system_validator">validator</a>);
        } <b>else</b> {
    ...
    // <a href="../rtd_system/validator_set.md#rtd_system_validator_set_new">new</a> total stake is the initial total minus the amount removed via validators we kicked out
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_derive_reference_gas_price">derive_reference_gas_price</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_derive_reference_gas_price">derive_reference_gas_price</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    <b>let</b> entries = self
        .<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>
        .map_ref!(|v| pq::new_entry(v.gas_price(), v.<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>()));
    ...
    <b>let</b> threshold = <a href="../rtd_system/voting_power.md#rtd_system_voting_power_total_voting_power">voting_power::total_voting_power</a>() - <a href="../rtd_system/voting_power.md#rtd_system_voting_power_quorum_threshold">voting_power::quorum_threshold</a>();
    <b>let</b> <b>mut</b> result = 0;
    <b>while</b> (sum &lt; threshold) {
        <b>let</b> (gas_price, <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>) = pq.pop_max();
        result = gas_price;
        sum = sum + <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>;
    };
    result
}
</code></pre>
...
<a name="rtd_system_validator_set_total_stake"></a>

## Function `total_stake`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>
}
</code></pre>
...
<a name="rtd_system_validator_set_validator_total_stake_amount"></a>

## Function `validator_total_stake_amount`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_total_stake_amount">validator_total_stake_amount</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): u64
</code></pre>
...
<a name="rtd_system_validator_set_validator_stake_amount"></a>

## Function `validator_stake_amount`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_stake_amount">validator_stake_amount</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): u64
</code></pre>
...
<a name="rtd_system_validator_set_validator_voting_power"></a>

## Function `validator_voting_power`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_voting_power">validator_voting_power</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): u64
</code></pre>
...
<a name="rtd_system_validator_set_validator_staking_pool_id"></a>

## Function `validator_staking_pool_id`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_staking_pool_id">validator_staking_pool_id</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): <a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>
</code></pre>
...
<a name="rtd_system_validator_set_staking_pool_mappings"></a>

## Function `staking_pool_mappings`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): &<a href="../rtd/table.md#rtd_table_Table">rtd::table::Table</a>&lt;<a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>, <b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): &Table&lt;ID, <b>address</b>&gt; {
    &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>
}
</code></pre>
...
<a name="rtd_system_validator_set_validator_address_by_pool_id"></a>

## Function `validator_address_by_pool_id`



<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_address_by_pool_id">validator_address_by_pool_id</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, pool_id: &<a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_validator_address_by_pool_id">validator_address_by_pool_id</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, pool_id: &ID): <b>address</b> {
    // If the pool id is recorded in the mapping, then it must be either candidate or active.
    <b>if</b> (self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.contains(*pool_id)) {
        self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>[*pool_id]
    } <b>else</b> {
        // otherwise it's inactive
        self.inactive_validators[*pool_id].load_validator_maybe_upgrade().rtd_address()
    }
}
</code></pre>
...
<a name="rtd_system_validator_set_pool_exchange_rates"></a>
...
<a name="rtd_system_validator_set_validator_by_pool_id"></a>
...
<a name="rtd_system_validator_set_next_epoch_validator_count"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_next_epoch_validator_count">next_epoch_validator_count</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): u64
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_next_epoch_validator_count">next_epoch_validator_count</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): u64 {
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.length() - self.pending_removals.length() + self.pending_active_validators.length()
}
</code></pre>
...
<a name="rtd_system_validator_set_is_active_validator_by_rtd_address"></a>

## Function `is_active_validator_by_rtd_address`

Returns true iff the address exists in active validators.


<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator_by_rtd_address">is_active_validator_by_rtd_address</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator_by_rtd_address">is_active_validator_by_rtd_address</a>(
    self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
): bool {
    <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(&self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>, validator_address).is_some()
}
</code></pre>
...
<a name="rtd_system_validator_set_is_duplicate_with_active_validator"></a>
...
It differs from <code><a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator_by_rtd_address">is_active_validator_by_rtd_address</a></code> in that the former checks
...
<a name="rtd_system_validator_set_is_duplicate_with_pending_validator"></a>
...
<a name="rtd_system_validator_set_get_candidate_or_active_validator_mut"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>): &<b>mut</b> <a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_candidate_or_active_validator_mut">get_candidate_or_active_validator_mut</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
): &<b>mut</b> Validator {
...
<a name="rtd_system_validator_set_find_validator"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, validator_address: <b>address</b>): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(validators: &vector&lt;Validator&gt;, validator_address: <b>address</b>): Option&lt;u64&gt; {
    validators.find_index!(|v| v.rtd_address() == validator_address)
}
</code></pre>
...
<a name="rtd_system_validator_set_find_validator_from_table_vec"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(validators: &<a href="../rtd/table_vec.md#rtd_table_vec_TableVec">rtd::table_vec::TableVec</a>&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, validator_address: <b>address</b>): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(
...
<a name="rtd_system_validator_set_get_validator_indices"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_indices">get_validator_indices</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, validator_addresses: &vector&lt;<b>address</b>&gt;): vector&lt;u64&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_indices">get_validator_indices</a>(
    validators: &vector&lt;Validator&gt;,
...
<a name="rtd_system_validator_set_get_validator_ref"></a>

## Function `get_validator_ref`



<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_ref">get_validator_ref</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, validator_address: <b>address</b>): &<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_ref">get_validator_ref</a>(validators: &vector&lt;Validator&gt;, validator_address: <b>address</b>): &Validator {
    <b>let</b> idx = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(validators, validator_address).destroy_or!(<b>abort</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENotAValidator">ENotAValidator</a>);
    &validators[idx]
}
</code></pre>
...
<a name="rtd_system_validator_set_get_active_or_pending_or_candidate_validator_ref"></a>

## Function `get_active_or_pending_or_candidate_validator_ref`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_active_or_pending_or_candidate_validator_ref">get_active_or_pending_or_candidate_validator_ref</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_address: <b>address</b>, which_validator: u8): &<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_active_or_pending_or_candidate_validator_ref">get_active_or_pending_or_candidate_validator_ref</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_address: <b>address</b>,
    which_validator: u8,
): &Validator {
    <b>let</b> <b>mut</b> validator_index_opt = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator">find_validator</a>(&self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>, validator_address);
    <b>if</b> (validator_index_opt.is_some() || which_validator == <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ACTIVE_VALIDATOR_ONLY">ACTIVE_VALIDATOR_ONLY</a>) {
        <b>let</b> validator_index = validator_index_opt.extract();
        <b>return</b> &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>[validator_index]
    };
    <b>let</b> <b>mut</b> validator_index_opt = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_find_validator_from_table_vec">find_validator_from_table_vec</a>(
        &self.pending_active_validators,
        validator_address,
    );
    <b>if</b> (validator_index_opt.is_some() || which_validator == <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ACTIVE_OR_PENDING_VALIDATOR">ACTIVE_OR_PENDING_VALIDATOR</a>) {
        <b>let</b> validator_index = validator_index_opt.extract();
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_verify_cap">verify_cap</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, cap: &<a href="../rtd_system/validator_cap.md#rtd_system_validator_cap_UnverifiedValidatorOperationCap">rtd_system::validator_cap::UnverifiedValidatorOperationCap</a>, which_validator: u8): <a href="../rtd_system/validator_cap.md#rtd_system_validator_cap_ValidatorOperationCap">rtd_system::validator_cap::ValidatorOperationCap</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_verify_cap">verify_cap</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
...
<a name="rtd_system_validator_set_process_pending_removals"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_pending_removals">process_pending_removals</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_report_records: &<b>mut</b> <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_pending_removals">process_pending_removals</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    validator_report_records: &<b>mut</b> VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
    ctx: &<b>mut</b> TxContext,
) {
    ...
    self.pending_removals.length().do!(|_| {
        ...
        self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_validator_departure">process_validator_departure</a>(
            <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>,
            validator_report_records,
            <b>true</b>, // the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> removes itself voluntarily
            ctx,
        );
    });
}
...
<a name="rtd_system_validator_set_process_validator_departure"></a>

## Function `process_validator_departure`

Remove <code><a href="../rtd_system/validator.md#rtd_system_validator">validator</a></code> from <code>self</code> and return the amount of stake that was removed


<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_validator_departure">process_validator_departure</a>(self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>: <a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>, validator_report_records: &<b>mut</b> <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, is_voluntary: bool, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_process_validator_departure">process_validator_departure</a>(
    self: &<b>mut</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    <b>mut</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>: Validator,
    validator_report_records: &<b>mut</b> VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
    is_voluntary: bool,
    ctx: &<b>mut</b> TxContext,
): u64 {
    <b>let</b> new_epoch = ctx.epoch() + 1;
    <b>let</b> validator_address = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.rtd_address();
    <b>let</b> validator_pool_id = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.staking_pool_id();
    // Remove the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> from our tables.
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_staking_pool_mappings">staking_pool_mappings</a>.remove(validator_pool_id);
    <b>if</b> (self.at_risk_validators.contains(&validator_address)) {
        self.at_risk_validators.remove(&validator_address);
    };
    <a href="../rtd_system/validator_set.md#rtd_system_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(validator_report_records, validator_address);
    event::emit(<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorLeaveEvent">ValidatorLeaveEvent</a> {
        epoch: new_epoch,
        validator_address,
        staking_pool_id: <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.staking_pool_id(),
        is_voluntary,
...
<a name="rtd_system_validator_set_clean_report_records_leaving_validator"></a>

## Function `clean_report_records_leaving_validator`



<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(validator_report_records: &<b>mut</b> <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, leaving_validator_addr: <b>address</b>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_clean_report_records_leaving_validator">clean_report_records_leaving_validator</a>(
    validator_report_records: &<b>mut</b> VecMap&lt;<b>address</b>, VecSet&lt;<b>address</b>&gt;&gt;,
    leaving_validator_addr: <b>address</b>,
) {
    // Remove the records about this <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>
    <b>if</b> (validator_report_records.contains(&leaving_validator_addr)) {
        validator_report_records.remove(&leaving_validator_addr);
    };
    // Remove the reports submitted by this <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_calculate_total_stakes">calculate_total_stakes</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;): u64
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_calculate_total_stakes">calculate_total_stakes</a>(validators: &vector&lt;Validator&gt;): u64 {
...
<a name="rtd_system_validator_set_compute_reward_adjustments"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(slashed_validator_indices: vector&lt;u64&gt;, reward_slashing_rate: u64, unadjusted_staking_reward_amounts: &vector&lt;u64&gt;, unadjusted_storage_fund_reward_amounts: &vector&lt;u64&gt;): (u64, <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u64, u64&gt;, u64, <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u64, u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_reward_adjustments">compute_reward_adjustments</a>(
    ...
    VecMap&lt;u64, u64&gt;, // mapping of individual <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>'s staking reward adjustment from index -&gt; amount
    u64, // sum of storage fund reward adjustments
    VecMap&lt;u64, u64&gt;, // mapping of individual <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>'s storage fund reward adjustment from index -&gt; amount
) {
    ...
    slashed_validator_indices.destroy!(|validator_index| {
        // Use the slashing rate to compute the amount of staking rewards slashed from this punished <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.
        <b>let</b> unadjusted_staking_reward = unadjusted_staking_reward_amounts[validator_index];
        <b>let</b> staking_reward_adjustment = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_mul_div">mul_div</a>!(
            unadjusted_staking_reward,
            reward_slashing_rate,
            <a href="../rtd_system/validator_set.md#rtd_system_validator_set_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>,
        );
        ...
        <b>let</b> storage_fund_reward_adjustment = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_mul_div">mul_div</a>!(
...
<a name="rtd_system_validator_set_compute_slashed_validators"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_slashed_validators">compute_slashed_validators</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, validator_report_records: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;): vector&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_slashed_validators">compute_slashed_validators</a>(
    self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>,
    ...
    <b>while</b> (!validator_report_records.is_empty()) {
        ...
        <b>assert</b>!(
            self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator_by_rtd_address">is_active_validator_by_rtd_address</a>(validator_address),
            <a href="../rtd_system/validator_set.md#rtd_system_validator_set_ENonValidatorInReportRecords">ENonValidatorInReportRecords</a>,
        );
        // Sum up the voting power of validators that have reported this <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> and check <b>if</b> it <b>has</b>
        // passed the slashing threshold.
        <b>let</b> reporter_votes = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(
            &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>,
            &reporters.into_keys(),
        );
        <b>if</b> (reporter_votes &gt;= <a href="../rtd_system/voting_power.md#rtd_system_voting_power_quorum_threshold">voting_power::quorum_threshold</a>()) {
...
<a name="rtd_system_validator_set_compute_unadjusted_reward_distribution"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, total_voting_power: u64, total_staking_reward: u64, total_storage_fund_reward: u64): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_unadjusted_reward_distribution">compute_unadjusted_reward_distribution</a>(
    validators: &vector&lt;Validator&gt;,
    ...
    validators.do_ref!(|<a href="../rtd_system/validator.md#rtd_system_validator">validator</a>| {
        // Integer divisions will truncate the results. Because of this, we expect that at the end
        // there will be some reward remaining in `total_staking_reward`.
        // Use u128 to avoid multiplication overflow.
        <b>let</b> <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a> = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>();
        <b>let</b> reward_amount = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_mul_div">mul_div</a>!(<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>, total_staking_reward, total_voting_power);
...
<a name="rtd_system_validator_set_compute_adjusted_reward_distribution"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(validators: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, total_voting_power: u64, total_slashed_validator_voting_power: u64, unadjusted_staking_reward_amounts: vector&lt;u64&gt;, unadjusted_storage_fund_reward_amounts: vector&lt;u64&gt;, total_staking_reward_adjustment: u64, individual_staking_reward_adjustments: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u64, u64&gt;, total_storage_fund_reward_adjustment: u64, individual_storage_fund_reward_adjustments: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u64, u64&gt;): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_compute_adjusted_reward_distribution">compute_adjusted_reward_distribution</a>(
    validators: &vector&lt;Validator&gt;,
    total_voting_power: u64,
    ...
    length.do!(|i| {
        <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = &validators[i];
        // Integer divisions will truncate the results. Because of this, we expect that at the end
        ...
        // If the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> is one of the slashed ones, then subtract the adjustment.
        <b>let</b> adjusted_staking_reward_amount = <b>if</b> (
            ...
            <b>let</b> adjustment = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_mul_div">mul_div</a>!(
                total_staking_reward_adjustment,
                <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>,
...
<a name="rtd_system_validator_set_distribute_reward"></a>

## Function `distribute_reward`



<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_distribute_reward">distribute_reward</a>(validators: &<b>mut</b> vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, adjusted_staking_reward_amounts: &vector&lt;u64&gt;, adjusted_storage_fund_reward_amounts: &vector&lt;u64&gt;, staking_rewards: &<b>mut</b> <a href="../rtd/balance.md#rtd_balance_Balance">rtd::balance::Balance</a>&lt;<a href="../rtd/rtd.md#rtd_rtd_RTD">rtd::rtd::RTD</a>&gt;, storage_fund_reward: &<b>mut</b> <a href="../rtd/balance.md#rtd_balance_Balance">rtd::balance::Balance</a>&lt;<a href="../rtd/rtd.md#rtd_rtd_RTD">rtd::rtd::RTD</a>&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_distribute_reward">distribute_reward</a>(
    validators: &<b>mut</b> vector&lt;Validator&gt;,
    adjusted_staking_reward_amounts: &vector&lt;u64&gt;,
    adjusted_storage_fund_reward_amounts: &vector&lt;u64&gt;,
    staking_rewards: &<b>mut</b> Balance&lt;RTD&gt;,
    storage_fund_reward: &<b>mut</b> Balance&lt;RTD&gt;,
    ctx: &<b>mut</b> TxContext,
) {
    <b>let</b> length = validators.length();
    <b>assert</b>!(length &gt; 0, <a href="../rtd_system/validator_set.md#rtd_system_validator_set_EValidatorSetEmpty">EValidatorSetEmpty</a>);
    length.do!(|i| {
        <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = &<b>mut</b> validators[i];
        ...
        <b>let</b> validator_commission_amount = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_mul_div">mul_div</a>!(
            staking_reward_amount,
            <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.commission_rate(),
            <a href="../rtd_system/validator_set.md#rtd_system_validator_set_BASIS_POINT_DENOMINATOR">BASIS_POINT_DENOMINATOR</a>,
        );
        // The <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> reward = storage_fund_reward + commission.
        <b>let</b> <b>mut</b> validator_reward = staker_reward.split(validator_commission_amount <b>as</b> u64);
        // Add storage fund rewards to the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>'s reward.
        validator_reward.join(storage_fund_reward.split(adjusted_storage_fund_reward_amounts[i]));
        // Add rewards to the <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>. Don't try and distribute rewards though <b>if</b> the payout is zero.
        <b>if</b> (validator_reward.value() &gt; 0) {
            <b>let</b> validator_address = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.rtd_address();
            <b>let</b> rewards_stake = <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_request_add_stake">request_add_stake</a>(
                validator_reward,
                validator_address,
                ctx,
            );
        ...
        <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.deposit_stake_rewards(staker_reward);
    });
}
</code></pre>
...
<a name="rtd_system_validator_set_emit_validator_epoch_events"></a>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(new_epoch: u64, vs: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, pool_staking_reward_amounts: &vector&lt;u64&gt;, storage_fund_staking_reward_amounts: &vector&lt;u64&gt;, report_records: &<a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, <a href="../rtd/vec_set.md#rtd_vec_set_VecSet">rtd::vec_set::VecSet</a>&lt;<b>address</b>&gt;&gt;, slashed_validators: &vector&lt;<b>address</b>&gt;)
</code></pre>
...
<pre><code><b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_emit_validator_epoch_events">emit_validator_epoch_events</a>(
    new_epoch: u64,
    vs: &vector&lt;Validator&gt;,
    ...
    length.do!(|i| {
        <b>let</b> v = &vs[i];
        <b>let</b> validator_address = v.rtd_address();
        ...
        event::emit(<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorEpochInfoEventV2">ValidatorEpochInfoEventV2</a> {
            epoch: new_epoch,
            validator_address,
            reference_gas_survey_quote: v.gas_price(),
            stake: v.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_total_stake">total_stake</a>(),
            <a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>: v.<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>(),
...
<a name="rtd_system_validator_set_sum_voting_power_by_addresses"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(vs: &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;, addresses: &vector&lt;<b>address</b>&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_sum_voting_power_by_addresses">sum_voting_power_by_addresses</a>(vs: &vector&lt;Validator&gt;, addresses: &vector&lt;<b>address</b>&gt;): u64 {
    <b>let</b> <b>mut</b> sum = 0;
    addresses.do_ref!(|addr| {
        <b>let</b> <a href="../rtd_system/validator.md#rtd_system_validator">validator</a> = <a href="../rtd_system/validator_set.md#rtd_system_validator_set_get_validator_ref">get_validator_ref</a>(vs, *addr);
        sum = sum + <a href="../rtd_system/validator.md#rtd_system_validator">validator</a>.<a href="../rtd_system/voting_power.md#rtd_system_voting_power">voting_power</a>();
    });
    sum
}
</code></pre>
...
<a name="rtd_system_validator_set_active_validators"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): &vector&lt;<a href="../rtd_system/validator.md#rtd_system_validator_Validator">rtd_system::validator::Validator</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): &vector&lt;Validator&gt; {
    &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>
}
</code></pre>
...
<a name="rtd_system_validator_set_is_validator_candidate"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_validator_candidate">is_validator_candidate</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, addr: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_validator_candidate">is_validator_candidate</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, addr: <b>address</b>): bool {
...
<a name="rtd_system_validator_set_is_active_validator"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator">is_active_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, addr: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_active_validator">is_active_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, addr: <b>address</b>): bool {
    self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>.any!(|v| v.rtd_address() == addr)
}
</code></pre>
...
<a name="rtd_system_validator_set_is_inactive_validator"></a>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, staking_pool_id: <a href="../rtd/object.md#rtd_object_ID">rtd::object::ID</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_inactive_validator">is_inactive_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, staking_pool_id: ID): bool {
...
<a name="rtd_system_validator_set_is_at_risk_validator"></a>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_at_risk_validator">is_at_risk_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>, addr: <b>address</b>): bool
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_is_at_risk_validator">is_at_risk_validator</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>, addr: <b>address</b>): bool {
...
<a name="rtd_system_validator_set_active_validator_addresses"></a>

## Function `active_validator_addresses`



<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validator_addresses">active_validator_addresses</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">rtd_system::validator_set::ValidatorSet</a>): vector&lt;<b>address</b>&gt;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validator_addresses">active_validator_addresses</a>(self: &<a href="../rtd_system/validator_set.md#rtd_system_validator_set_ValidatorSet">ValidatorSet</a>): vector&lt;<b>address</b>&gt; {
    <b>let</b> vs = &self.<a href="../rtd_system/validator_set.md#rtd_system_validator_set_active_validators">active_validators</a>;
    <b>let</b> <b>mut</b> res = vector[];
    vs.do_ref!(|v| res.push_back(v.rtd_address()));
    res
}
</code></pre>
...
<a name="rtd_system_validator_set_mul_div"></a>
