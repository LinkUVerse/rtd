...
-  [Function `execute_add_tokens_on_rtd`](#bridge_bridge_execute_add_tokens_on_rtd)
...
<b>use</b> <a href="../rtd/ecdsa_k1.md#rtd_ecdsa_k1">rtd::ecdsa_k1</a>;
...
<b>use</b> <a href="../rtd/object_bag.md#rtd_object_bag">rtd::object_bag</a>;
...
<dt>
<code>sequence_nums: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u8, u64&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<dt>
<code>token_transfer_records: <a href="../rtd/linked_table.md#rtd_linked_table_LinkedTable">rtd::linked_table::LinkedTable</a>&lt;<a href="../bridge/message.md#bridge_message_BridgeMessageKey">bridge::message::BridgeMessageKey</a>, <a href="../bridge/bridge.md#bridge_bridge_BridgeRecord">bridge::bridge::BridgeRecord</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
...
<a name="bridge_bridge_EInvariantRtdInitializedTokenTransferShouldNotBeClaimed"></a>



<pre><code><b>const</b> <a href="../bridge/bridge.md#bridge_bridge_EInvariantRtdInitializedTokenTransferShouldNotBeClaimed">EInvariantRtdInitializedTokenTransferShouldNotBeClaimed</a>: u64 = 10;
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_create">create</a>(id: <a href="../rtd/object.md#rtd_object_UID">rtd::object::UID</a>, chain_id: u8, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_init_bridge_committee">init_bridge_committee</a>(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, active_validator_voting_power: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<b>address</b>, u64&gt;, min_stake_participation_percentage: u64, ctx: &<a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_committee_registration">committee_registration</a>(
    <a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">Bridge</a>,
    system_state: &<b>mut</b> RtdSystemState,
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_register_foreign_token">register_foreign_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, tc: <a href="../rtd/coin.md#rtd_coin_TreasuryCap">rtd::coin::TreasuryCap</a>&lt;T&gt;, uc: <a href="../rtd/package.md#rtd_package_UpgradeCap">rtd::package::UpgradeCap</a>, metadata: &<a href="../rtd/coin.md#rtd_coin_CoinMetadata">rtd::coin::CoinMetadata</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_send_token">send_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, target_chain: u8, target_address: vector&lt;u8&gt;, token: <a href="../rtd/coin.md#rtd_coin_Coin">rtd::coin::Coin</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_approve_token_transfer">approve_token_transfer</a>(
    ...
    // retrieve pending <a href="../bridge/message.md#bridge_message">message</a> <b>if</b> source chain is Rtd, the initial <a href="../bridge/message.md#bridge_message">message</a>
    // must exist on chain
    <b>if</b> (<a href="../bridge/message.md#bridge_message">message</a>.source_chain() == inner.chain_id) {
        ...
        <b>assert</b>!(!record.claimed, <a href="../bridge/bridge.md#bridge_bridge_EInvariantRtdInitializedTokenTransferShouldNotBeClaimed">EInvariantRtdInitializedTokenTransferShouldNotBeClaimed</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token">claim_token</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, clock: &<a href="../rtd/clock.md#rtd_clock_Clock">rtd::clock::Clock</a>, source_chain: u8, bridge_seq_num: u64, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd/coin.md#rtd_coin_Coin">rtd::coin::Coin</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_system_message">execute_system_message</a>(
    ...
    } <b>else</b> <b>if</b> (message_type == <a href="../bridge/message_types.md#bridge_message_types_add_tokens_on_rtd">message_types::add_tokens_on_rtd</a>()) {
        <b>let</b> payload = <a href="../bridge/message.md#bridge_message">message</a>.extract_add_tokens_on_rtd();
        inner.<a href="../bridge/bridge.md#bridge_bridge_execute_add_tokens_on_rtd">execute_add_tokens_on_rtd</a>(payload);
    } <b>else</b> {
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_claim_token_internal">claim_token_internal</a>&lt;T&gt;(<a href="../bridge/bridge.md#bridge_bridge">bridge</a>: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_Bridge">bridge::bridge::Bridge</a>, clock: &<a href="../rtd/clock.md#rtd_clock_Clock">rtd::clock::Clock</a>, source_chain: u8, bridge_seq_num: u64, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): (<a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="../rtd/coin.md#rtd_coin_Coin">rtd::coin::Coin</a>&lt;T&gt;&gt;, <b>address</b>)
</code></pre>
...
<a name="bridge_bridge_execute_add_tokens_on_rtd"></a>

## Function `execute_add_tokens_on_rtd`



<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_add_tokens_on_rtd">execute_add_tokens_on_rtd</a>(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">bridge::bridge::BridgeInner</a>, payload: <a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>)
</code></pre>
...
<pre><code><b>fun</b> <a href="../bridge/bridge.md#bridge_bridge_execute_add_tokens_on_rtd">execute_add_tokens_on_rtd</a>(inner: &<b>mut</b> <a href="../bridge/bridge.md#bridge_bridge_BridgeInner">BridgeInner</a>, payload: AddTokenOnRtd) {
