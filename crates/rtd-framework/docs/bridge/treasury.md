...
<dl>
<dt>
<code>treasuries: <a href="../rtd/object_bag.md#rtd_object_bag_ObjectBag">rtd::object_bag::ObjectBag</a></code>
</dt>
<dd>
</dd>
<dt>
<code>supported_tokens: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>, <a href="../bridge/treasury.md#bridge_treasury_BridgeTokenMetadata">bridge::treasury::BridgeTokenMetadata</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>id_token_type_map: <a href="../rtd/vec_map.md#rtd_vec_map_VecMap">rtd::vec_map::VecMap</a>&lt;u8, <a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;</code>
</dt>
<dd>
</dd>
<dt>
<code>waiting_room: <a href="../rtd/bag.md#rtd_bag_Bag">rtd::bag::Bag</a></code>
</dt>
<dd>
</dd>
</dl>
...
<dt>
<code>uc: <a href="../rtd/package.md#rtd_package_UpgradeCap">rtd::package::UpgradeCap</a></code>
</dt>
<dd>
</dd>
<dt>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_register_foreign_token">register_foreign_token</a>&lt;T&gt;(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, tc: <a href="../rtd/coin.md#rtd_coin_TreasuryCap">rtd::coin::TreasuryCap</a>&lt;T&gt;, uc: <a href="../rtd/package.md#rtd_package_UpgradeCap">rtd::package::UpgradeCap</a>, metadata: &<a href="../rtd/coin.md#rtd_coin_CoinMetadata">rtd::coin::CoinMetadata</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_create">create</a>(ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_burn">burn</a>&lt;T&gt;(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, token: <a href="../rtd/coin.md#rtd_coin_Coin">rtd::coin::Coin</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../bridge/treasury.md#bridge_treasury_mint">mint</a>&lt;T&gt;(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, amount: u64, ctx: &<b>mut</b> <a href="../rtd/tx_context.md#rtd_tx_context_TxContext">rtd::tx_context::TxContext</a>): <a href="../rtd/coin.md#rtd_coin_Coin">rtd::coin::Coin</a>&lt;T&gt;
</code></pre>
