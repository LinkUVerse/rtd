...
-  [Struct `AddTokenOnRtd`](#bridge_message_AddTokenOnRtd)
...
-  [Function `extract_add_tokens_on_rtd`](#bridge_message_extract_add_tokens_on_rtd)
...
-  [Function `create_add_tokens_on_rtd_message`](#bridge_message_create_add_tokens_on_rtd_message)
...
<a name="bridge_message_AddTokenOnRtd"></a>

## Struct `AddTokenOnRtd`



<pre><code><b>public</b> <b>struct</b> <a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a> <b>has</b> drop
</code></pre>
...
<a name="bridge_message_extract_add_tokens_on_rtd"></a>

## Function `extract_add_tokens_on_rtd`



<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_extract_add_tokens_on_rtd">extract_add_tokens_on_rtd</a>(<a href="../bridge/message.md#bridge_message">message</a>: &<a href="../bridge/message.md#bridge_message_BridgeMessage">bridge::message::BridgeMessage</a>): <a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_extract_add_tokens_on_rtd">extract_add_tokens_on_rtd</a>(<a href="../bridge/message.md#bridge_message">message</a>: &<a href="../bridge/message.md#bridge_message_BridgeMessage">BridgeMessage</a>): <a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a> {
    <b>let</b> <b>mut</b> bcs = bcs::new(<a href="../bridge/message.md#bridge_message">message</a>.<a href="../bridge/message.md#bridge_message_payload">payload</a>);
    ...
    <b>assert</b>!(bcs.into_remainder_bytes().is_empty(), <a href="../bridge/message.md#bridge_message_ETrailingBytes">ETrailingBytes</a>);
    <a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a> {
        native_token,
...
<a name="bridge_message_create_add_tokens_on_rtd_message"></a>

## Function `create_add_tokens_on_rtd_message`

Update Rtd token message
[message_type:u8]
[version:u8]
[nonce:u64]
[chain_id: u8]
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_create_add_tokens_on_rtd_message">create_add_tokens_on_rtd_message</a>(
    <a href="../bridge/message.md#bridge_message_source_chain">source_chain</a>: u8,
    <a href="../bridge/message.md#bridge_message_seq_num">seq_num</a>: u64,
    native_token: bool,
    ...
    <a href="../bridge/message.md#bridge_message_BridgeMessage">BridgeMessage</a> {
        <a href="../bridge/message.md#bridge_message_message_type">message_type</a>: <a href="../bridge/message_types.md#bridge_message_types_add_tokens_on_rtd">message_types::add_tokens_on_rtd</a>(),
        <a href="../bridge/message.md#bridge_message_message_version">message_version</a>: <a href="../bridge/message.md#bridge_message_CURRENT_MESSAGE_VERSION">CURRENT_MESSAGE_VERSION</a>,
        <a href="../bridge/message.md#bridge_message_seq_num">seq_num</a>,
        <a href="../bridge/message.md#bridge_message_source_chain">source_chain</a>,
        <a href="../bridge/message.md#bridge_message_payload">payload</a>,
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_is_native">is_native</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_is_native">is_native</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a>): bool {
    self.native_token
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_ids">token_ids</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>): vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_ids">token_ids</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a>): vector&lt;u8&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_type_names">token_type_names</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>): vector&lt;<a href="../std/ascii.md#std_ascii_String">std::ascii::String</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_type_names">token_type_names</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a>): vector&lt;String&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_prices">token_prices</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">bridge::message::AddTokenOnRtd</a>): vector&lt;u64&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_token_prices">token_prices</a>(self: &<a href="../bridge/message.md#bridge_message_AddTokenOnRtd">AddTokenOnRtd</a>): vector&lt;u64&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="../bridge/message.md#bridge_message_required_voting_power">required_voting_power</a>(self: &<a href="../bridge/message.md#bridge_message_BridgeMessage">BridgeMessage</a>): u64 {
    ...
    <b>if</b> (<a href="../bridge/message.md#bridge_message_message_type">message_type</a> == <a href="../bridge/message_types.md#bridge_message_types_token">message_types::token</a>()) {
        ...
        5001
    } <b>else</b> <b>if</b> (<a href="../bridge/message.md#bridge_message_message_type">message_type</a> == <a href="../bridge/message_types.md#bridge_message_types_add_tokens_on_rtd">message_types::add_tokens_on_rtd</a>()) {
        5001
    } <b>else</b> {
...
<pre><code><b>fun</b> <a href="../bridge/message.md#bridge_message_peel_u64_be">peel_u64_be</a>(bcs: &<b>mut</b> <a href="../rtd/bcs.md#rtd_bcs_BCS">rtd::bcs::BCS</a>): u64
</code></pre>
