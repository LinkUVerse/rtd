...
module deepbook::clob {
    ...
    use rtd::rtd::RTD;
    use rtd::table::{Self, Table, contains, borrow_mut};
    ...
    public struct Order has store, drop {
        ...
        // Assuming a maximum TPS of 100K/s of Rtd chain, it would take (1<<63) / 100000 / 3600 / 24 / 365 = 2924712 years to reach the full capacity.
