...
#[test_only]
module rtd_system::validator_tests;
...
fun validator_owner_flow() {
    ...
    assert_eq!(validator.rtd_address(), @2);
...
fun pending_validator_flow() {
    ...
    runner.owned_tx!<StakedRtd>(|staked_rtd| {
        let withdrawn_balance = validator
            .request_withdraw_stake(staked_rtd, runner.ctx())
            .destroy_for_testing();
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidPubkey)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidNetPubkey)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidWorkerPubkey)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidNetAddr)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidP2pAddr)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidPrimaryAddr)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EMetadataInvalidWorkerAddr)]
...
#[test, expected_failure(abort_code = rtd_system::validator::EInvalidProofOfPossession)]
...
#[
    test,
    expected_failure(
        abort_code = rtd_system::validator::EValidatorMetadataExceedingLengthLimit,
    ),
]
