...
#[test_only]
module rtd_system::validator_metadata_tests;

use rtd::test_scenario::{Self, Scenario};
use rtd::url;
use rtd_system::rtd_system::RtdSystemState;
use rtd_system::test_runner::{Self, TestRunner};
...
fun active_validator_update_metadata() {
    ...
    let validator = validator_builder::preset()
        .rtd_address(new_validator_addr)
...
// Note: `pop` MUST be a valid signature using rtd_address and protocol_pubkey_bytes.
