...
#[test, expected_failure(abort_code = fixed_point32::ERATIO_OUT_OF_RANGE)]
fun create_overflow() {
...
#[test, expected_failure(abort_code = fixed_point32::EDIVISION_BY_ZERO)]
fun divide_by_zero() {
...
fun create_from_rational_max_numerator_denominator() {
    ...
    assert_eq!(one, 4294967296); // 0x1.00000000
}
