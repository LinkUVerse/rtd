...
#[test_only]
module rtd::poseidon_tests;

use std::u64::min;
use rtd::poseidon::poseidon_bn254;
...
#[test]
#[expected_failure(abort_code = rtd::poseidon::ENonCanonicalInput)]
...
#[test]
#[expected_failure(abort_code = rtd::poseidon::EEmptyInput)]
...
#[test]
#[expected_failure(abort_code = rtd::poseidon::ETooManyInputs)]
