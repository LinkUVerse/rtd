...
#[test_only]
module rtd::zklogin_verified_id_tests;

use rtd::test_scenario;
use rtd::zklogin_verified_id::{check_zklogin_id, verify_zklogin_id};

#[test]
#[expected_failure(abort_code = rtd::zklogin_verified_id::EFunctionDisabled)]
