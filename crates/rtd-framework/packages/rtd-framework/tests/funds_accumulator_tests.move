...
#[test_only]
module rtd::funds_accumulator_tests;

use std::unit_test::assert_eq;
use rtd::funds_accumulator::create_withdrawal;
...
#[random_test]
#[expected_failure(abort_code = rtd::funds_accumulator::EInvalidSubLimit)]
...
#[test]
#[expected_failure(abort_code = rtd::funds_accumulator::EOwnerMismatch)]
...
#[random_test]
#[expected_failure(abort_code = rtd::funds_accumulator::EOverflow)]
