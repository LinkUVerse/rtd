...
fun config_create<WriteCap>(cap: &mut WriteCap, ctx: &mut TxContext) {
    rtd::config::share(rtd::config::new(cap, ctx))
}
...
#[test, expected_failure(abort_code = rtd::config::EAlreadySetForEpoch)]
...
#[test, expected_failure(abort_code = rtd::config::ENotSetForEpoch)]
...
#[test, expected_failure(abort_code = rtd::dynamic_field::EFieldTypeMismatch)]
