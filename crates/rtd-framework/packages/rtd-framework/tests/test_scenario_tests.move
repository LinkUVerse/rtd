...
#[test_only]
module rtd::test_scenario_tests;
...
fun create_system_objects() {
    ...
    let clock = scenario.take_shared<rtd::clock::Clock>();
    test_scenario::return_shared(clock);

    let random = scenario.take_shared<rtd::random::Random>();
    test_scenario::return_shared(random);

    let deny_list = scenario.take_shared<rtd::deny_list::DenyList>();
