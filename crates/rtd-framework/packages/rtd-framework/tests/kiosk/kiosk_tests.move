...
module rtd::kiosk_tests;

use rtd::coin;
use rtd::kiosk_test_utils::{Self as test, Asset};
use rtd::rtd::RTD;
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EItemLocked)]
...
fun test_purchase() {
    ...
    let payment = coin::mint_for_testing<RTD>(AMT, ctx);
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::ENotListed)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EListedExclusively)]
...
#[allow(unused_field)]
public struct WrongAsset has key, store { id: rtd::object::UID }

#[test]
#[expected_failure(abort_code = rtd::kiosk::EItemNotFound)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EIncorrectAmount)]
fun test_purchase_wrong_amount() {
    ...
    kiosk.place_and_list(&owner_cap, asset, AMT);
    let payment = coin::mint_for_testing<RTD>(AMT + 1, ctx);
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EAlreadyListed)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::ENotEmpty)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::ENotEnough)]
...
fun test_uid_access() {
    ...
    let uid = kiosk.uid();
    assert!(rtd::object::uid_to_inner(uid) == rtd::object::id(&kiosk));

    test::return_kiosk(kiosk, owner_cap, ctx);
}

#[test]
#[expected_failure(abort_code = rtd::kiosk::EUidAccessNotAllowed)]
