...
module rtd::kiosk_borrow_tests;

use rtd::kiosk_test_utils::{Self as utils, Asset};
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::ENotOwner)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EItemIsListed)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EWrongKiosk)]
...
#[test]
#[expected_failure(abort_code = rtd::kiosk::EItemMismatch)]
