...
#[test_only]
module rtd::witness_policy_tests {
    use rtd::transfer_policy as policy;
    use rtd::transfer_policy_tests::{Self as test, Asset};
    use rtd::witness_policy;
    ...
    #[test]
    #[expected_failure(abort_code = rtd::witness_policy::ERuleNotFound)]
