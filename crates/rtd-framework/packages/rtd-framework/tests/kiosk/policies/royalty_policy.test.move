...
#[test_only]
module rtd::royalty_policy_tests {
    use rtd::coin;
    use rtd::royalty_policy;
    use rtd::rtd::RTD;
    use rtd::transfer_policy as policy;
    use rtd::transfer_policy_tests as test;
    ...
    fun test_default_flow() {
        ...
        let mut payment = coin::mint_for_testing<RTD>(2000, ctx);
    ...
    #[test]
    #[expected_failure(abort_code = rtd::royalty_policy::EIncorrectArgument)]
    ...
    #[test]
    #[expected_failure(abort_code = rtd::royalty_policy::EInsufficientAmount)]
    fun test_insufficient_amount() {
        ...
        let mut request = policy::new_request(test::fresh_id(ctx), 100_000, test::fresh_id(ctx));
        let mut payment = coin::mint_for_testing<RTD>(999, ctx);
