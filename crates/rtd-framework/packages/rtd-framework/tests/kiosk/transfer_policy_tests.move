...
#[test_only]
module rtd::malicious_policy {
    use rtd::transfer_policy::{Self as policy, TransferRequest};
...
#[test_only]
module rtd::transfer_policy_tests {
    use rtd::coin;
    use rtd::dummy_policy;
    use rtd::malicious_policy;
    use rtd::package;
    use rtd::transfer_policy::{Self as policy, TransferPolicy, TransferPolicyCap};
    ...
    #[test]
    #[expected_failure(abort_code = rtd::transfer_policy::EPolicyNotSatisfied)]
    ...
    #[test]
    #[expected_failure(abort_code = rtd::transfer_policy::ERuleAlreadySet)]
    ...
    #[test]
    #[expected_failure(abort_code = rtd::transfer_policy::EIllegalRule)]
