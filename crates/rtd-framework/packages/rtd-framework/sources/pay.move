...
/// This module provides handy functionality for wallets and `rtd::Coin` management.
module rtd::pay;
...
/// Aborts with `rtd::balance::ENotEnough` if `amount` is greater than the balance in `c`
