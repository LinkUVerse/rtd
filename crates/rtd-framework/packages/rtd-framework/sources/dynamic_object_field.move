...
/// Similar to `rtd::dynamic_field`, this module allows for the access of dynamic fields. But
/// unlike, `rtd::dynamic_field` the values bound to these dynamic fields _must_ be objects
...
module rtd::dynamic_object_field;
