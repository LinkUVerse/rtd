...
The config file for the light client takes a URL for a full node, a directory to store checkpoint summaries (that must exist) and within the directory to name of the genesis blob for the Rtd network. 

```
full_node_url: "https://fullnode.mainnet.rtd.io:443"
...
object_store_url: "https://checkpoints.mainnet.rtd.io"
graphql_url: "https://rtd-mainnet.linkulabs.com/graphql"
archive_store_config:
  object-store: "S3"
  bucket: "linku-mainnet-archives"
  no-sign-request: true
  aws-region: "us-west-2"
  object-store-connection-limit: 20
```

The genesis blob for the Rtd mainnet can be found here: https://github.com/LinkUVerse/rtd-genesis/blob/main/mainnet/genesis.blob. Download and place it inside the checkpoint summary directory. 
...
```
$ rtd-light-client --config mainnet.yaml sync
```
...
```
$ rtd-light-client --config mainnet.yaml transaction -t 8RiKBwuAbtu8zNCtz8SrcfHyEUzto6zi6cMVA9t4WhWk
```
...
```
$ rtd-light-client --config light_client.yaml object -o 0xa514c85e1844189a54f4bfabc0928cbcac2137b928bef61adade84bbb486fd1f
```
