...
module rtd_system::rtd_system_state_inner {
    ...
    use rtd_system::validator::{Validator, ValidatorV2};
    use rtd_system::validator_wrapper::ValidatorWrapper;
    use rtd_system::validator_wrapper;
    use rtd::object;
    use rtd_system::validator;
    ...
    public(package) fun protocol_version(self: &RtdSystemStateInnerV2): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &RtdSystemStateInnerV2): u64 { self.system_state_version }
    ...
    public(package) fun v1_to_v2(v1: RtdSystemStateInner): RtdSystemStateInnerV2 {
    ...
    fun touch_dummy_inactive_validator(self: &mut RtdSystemStateInnerV2) {
    ...
    public(package) fun store_execution_time_estimates(self: &mut RtdSystemStateInnerV2, estimates: vector<u8>) {
