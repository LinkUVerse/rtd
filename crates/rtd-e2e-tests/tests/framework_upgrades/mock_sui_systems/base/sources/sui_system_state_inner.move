...
module rtd_system::rtd_system_state_inner {
    ...
    public(package) fun create(
        ...
        let mut system_state = RtdSystemStateInner {
            epoch: 0,
            protocol_version,
    ...
    public(package) fun protocol_version(self: &RtdSystemStateInner): u64 { self.protocol_version }
    public(package) fun system_state_version(self: &RtdSystemStateInner): u64 { self.system_state_version }
    public(package) fun genesis_system_state_version(): u64 {
        SYSTEM_STATE_VERSION_V1
    }

    public(package) fun add_dummy_inactive_validator_for_testing(self: &mut RtdSystemStateInner, ctx: &mut TxContext) {
    ...
    public(package) fun store_execution_time_estimates(self: &mut RtdSystemStateInner, estimates: vector<u8>) {
