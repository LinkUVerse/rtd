...
use rtd_cluster_test::{ClusterTest, config::ClusterTestOpt};
...
#[tokio::test]
async fn test_rtd_cluster() {
    use reqwest::StatusCode;
    use rtd_cluster_test::cluster::Cluster;
    use rtd_cluster_test::cluster::LocalNewCluster;
    use rtd_graphql_rpc::client::simple_client::SimpleClient;
