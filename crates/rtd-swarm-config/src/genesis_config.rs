...
use rtd_genesis_builder::validator_info::{GenesisValidatorInfo, ValidatorInfo};
...
pub struct ValidatorGenesisConfig {
    ...
    #[serde(default = "default_rtd_key_pair")]
    pub account_key_pair: RtdKeyPair,
    #[serde(default = "default_ed25519_key_pair")]
...
impl ValidatorGenesisConfig {
    pub fn to_validator_info(&self, name: String) -> GenesisValidatorInfo {
        ...
        let info = ValidatorInfo {
            ...
            worker_key,
            network_key,
            account_address: RtdAddress::from(&account_key),
...
fn default_rtd_key_pair() -> RtdKeyPair {
    RtdKeyPair::Ed25519(get_key_pair_from_rng(&mut rand::rngs::OsRng).1)
}

#[derive(Serialize, Deserialize, Debug, Clone)]
pub struct AccountConfig {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<RtdAddress>,
...
impl GenesisConfig {
    ...
    pub fn for_local_testing_with_addresses(addresses: Vec<RtdAddress>) -> Self {
    ...
    pub fn benchmark_gas_keys(n: usize) -> Vec<RtdKeyPair> {
        let mut rng = StdRng::seed_from_u64(Self::BENCHMARKS_RNG_SEED);
        (0..n)
            .map(|_| RtdKeyPair::Ed25519(NetworkKeyPair::generate(&mut rng)))
            .collect()
    }
