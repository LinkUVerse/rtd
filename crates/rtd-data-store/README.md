...
after the GraphQL schema in `crates/rtd-indexer-alt-graphql/schema.graphql`.
...
```rust
use rtd_data_store::{Node, stores::{DataStore, LruMemoryStore, ReadThroughStore, FileSystemStore}};
