...
//! Multi-tier caching data store for Rtd blockchain data.
//!
//! This crate provides a flexible data store abstraction for retrieving and caching
//! Rtd blockchain data (transactions, epochs, objects). The stores are loosely modeled
//! after the GQL schema in `crates/rtd-indexer-alt-graphql/schema.graphql`.
//!
//! ## Core Traits
//!
...
/// The data provided to `rtd_execution::executor::Executor::execute_transaction_to_effects`
...
/// `crates/rtd-indexer-alt-graphql/schema.graphql::multiGetObjects`.
