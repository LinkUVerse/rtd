...
//# run 0x3::rtd_system::request_add_stake --args object(0x5) object(3,0) @validator_0 --sender C
...
//# run-graphql
# Fetch coins of 0x2::rtd::RTD inner type
{
  objects(filter: {type: "0x2::coin::Coin<0x2::rtd::RTD>"}) {
    edges {
      node {
        asMoveObject {
          contents {
