...
use std::sync::Arc;
use rtd_bridge::events::MoveTokenDepositedEvent;
        ...
        for tx in &checkpoint.transactions {
            ...
            for ev in tx.events.iter().flat_map(|e| &e.data) {
                ...
                results.push(TokenTransferData {
                    ...
                    amount: event.amount_rtd_adjusted as i64,
                    is_finalized: true,
...
impl Handler for TokenTransferDataHandler {
    ...
    ) -> rtd_indexer_alt_framework::Result<usize> {
