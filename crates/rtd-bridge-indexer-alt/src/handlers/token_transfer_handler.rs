...
use rtd_bridge_schema::models::{BridgeDataSource, TokenTransfer, TokenTransferStatus};
use rtd_bridge_schema::schema::token_transfer;
        ...
        for tx in &checkpoint.transactions {
            ...
            for ev in tx.events.iter().flat_map(|e| &e.data) {
                let (chain_id, nonce) = if self.deposited_event_type == ev.type_ {
                    ...
                    self.metrics
                        .bridge_events_total
                        .with_label_values(&["token_deposited", "rtd"])
                        .inc();
                    self.metrics
                    ...
                    self.metrics
                        ...
                        .with_label_values(&["rtd_to_eth", "true"])
                    ...
                    self.metrics
                        .bridge_events_total
                        .with_label_values(&["transfer_approved", "rtd"])
                        .inc();
                    self.metrics
                        .token_transfers_total
                        .with_label_values(&["eth_to_rtd", "approved", "unknown"])
                        .inc();
                    ...
                    self.metrics
                        .bridge_events_total
                        .with_label_values(&["transfer_claimed", "rtd"])
                        .inc();
                    self.metrics
                        .token_transfers_total
                        .with_label_values(&["eth_to_rtd", "claimed", "unknown"])
                        .inc();
