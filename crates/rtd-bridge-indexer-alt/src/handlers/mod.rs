...
use rtd_indexer_alt_framework::types::RTD_BRIDGE_OBJECT_ID;
use rtd_indexer_alt_framework::types::full_checkpoint_content::ExecutedTransaction;
...
pub fn is_bridge_txn(txn: &ExecutedTransaction) -> bool {
    txn.transaction
        ...
        .iter()
        .flatten()
        .any(|obj| obj.object_id() == RTD_BRIDGE_OBJECT_ID)
}
