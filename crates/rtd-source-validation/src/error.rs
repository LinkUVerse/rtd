...
use rtd_json_rpc_types::RtdRawMoveObject;
use rtd_package_management::PublishedAtError;
use rtd_sdk::error::Error as SdkError;
use rtd_types::{base_types::ObjectID, error::RtdObjectResponseError};
...
pub enum Error {
    ...
    #[error("Dependency ID contains a Rtd object, not a Move package: {0}")]
    ObjectFoundWhenPackageExpected(ObjectID, RtdRawMoveObject),
    ...
    RtdObjectRefFailure(RtdObjectResponseError),
