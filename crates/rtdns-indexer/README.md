...
This indexer is used to cache the on-chain state of the RtdNS registry to a database,
...
- `BACKFILL_PROGRESS_FILE_PATH`: Expects a file in the format `{ "rtdns_indexing": <starting_checkpoint> }`
