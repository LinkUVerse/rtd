...
pub struct TxnContextAndEffects {
    ...
    pub gas_status: RtdGasStatus,              // gas status of the replay execution
...
impl ReplayStore<'_> {
    ...
    fn get_object_at_version(
        ...
        let object = self
            ...
            .map_err(|e| RtdErrorKind::Storage(e.to_string()))
            .ok()?
            .into_iter()
            .next()?
...
impl rtd_types::storage::ObjectStore for ReplayStore<'_> {
