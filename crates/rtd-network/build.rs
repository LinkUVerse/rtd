...
fn main() -> Result<()> {
    ...
    let codec_path = "linku_network::codec::BcsCodec";
    let prost_codec_path = "tonic_prost::ProstCodec";

    let validator_service = Service::builder()
        .name("Validator")
        .package("rtd.validator")
        .comment("The Validator interface")
        .method(
            Method::builder()
                .name("submit_transaction")
                .route_name("SubmitTransaction")
                .input_type("rtd_types::messages_grpc::RawSubmitTxRequest")
                .output_type("rtd_types::messages_grpc::RawSubmitTxResponse")
        ...
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::RawWaitForEffectsRequest")
                .output_type("rtd_types::messages_grpc::RawWaitForEffectsResponse")
                .codec_path(prost_codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::transaction::Transaction")
                .output_type("rtd_types::messages_grpc::HandleTransactionResponse")
        ...
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::transaction::CertifiedTransaction")
                .output_type("rtd_types::messages_grpc::HandleCertificateResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::HandleCertificateRequestV3")
                .output_type("rtd_types::messages_grpc::HandleCertificateResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::HandleSoftBundleCertificatesRequestV3")
                .output_type("rtd_types::messages_grpc::HandleSoftBundleCertificatesResponseV3")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::transaction::CertifiedTransaction")
                .output_type("rtd_types::messages_grpc::SubmitCertificateResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::ObjectInfoRequest")
                .output_type("rtd_types::messages_grpc::ObjectInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::TransactionInfoRequest")
                .output_type("rtd_types::messages_grpc::TransactionInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_checkpoint::CheckpointRequest")
                .output_type("rtd_types::messages_checkpoint::CheckpointResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_checkpoint::CheckpointRequestV2")
                .output_type("rtd_types::messages_checkpoint::CheckpointResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::SystemStateRequest")
                .output_type("rtd_types::rtd_system_state::RtdSystemState")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("rtd_types::messages_grpc::RawValidatorHealthRequest")
                .output_type("rtd_types::messages_grpc::RawValidatorHealthResponse")
                .codec_path(prost_codec_path)
                .build(),
        )
        .build();
    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("rtd_types::messages_checkpoint::CertifiedCheckpointSummary")
                .response_type("()")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type("Option<rtd_types::messages_checkpoint::CertifiedCheckpointSummary>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("rtd_types::messages_checkpoint::CheckpointContentsDigest")
                .response_type("Option<rtd_types::messages_checkpoint::FullCheckpointContents>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
