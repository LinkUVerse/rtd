...
impl Metrics {
    ...
    pub fn checkpoint_summary_age_metrics(&self) -> Option<(&Histogram, &LinkUHistogram)> {
        if let Some(inner) = &self.0 {
            return Some((
...
struct Inner {
    ...
    checkpoint_summary_age_ms: LinkUHistogram,
}
...
impl Inner {
    pub fn new(registry: &Registry) -> Arc<Self> {
        Self {
            ...
            .unwrap(),
            checkpoint_summary_age_ms: LinkUHistogram::new_in_registry(
