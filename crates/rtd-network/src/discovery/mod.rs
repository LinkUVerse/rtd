...
use rtd_config::p2p::{AccessType, DiscoveryConfig, P2pConfig, SeedPeer};
use rtd_types::crypto::{NetworkKeyPair, Signer, ToFromBytes, VerifyingKey};
...
mod generated {
    include!(concat!(env!("OUT_DIR"), "/rtd.Discovery.rs"));
}
mod builder;
mod metrics;
mod server;
