...
impl Command {
    ...
    pub fn new_pay_rtd() -> Self {
        Self {
            data: CommandData::PayRtd(PayRtd {}),
            ..Default::default()
        }
    }
    ...
    pub fn new_get_all_balances(addresses: Vec<RtdAddress>, chunk_size: usize) -> Self {
