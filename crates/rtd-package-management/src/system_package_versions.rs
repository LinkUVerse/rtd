...
pub const SYSTEM_GIT_REPO: &str = "https://github.com/LinkUVerse/rtd.git";
...
pub struct SystemPackage {
    /// The name of the package, e.g. "Rtd"
    pub package_name: String,

    /// The path to the package in the rtd monorepo
    /// e.g. "crates/rtd-framework/packages/rtd-framework"
