...
use rtd_types::crypto::DefaultHash;
use rtd_types::deny_list_v1::{PerTypeDenyList, get_coin_deny_list};
...
impl Genesis {
    ...
    pub fn validator_set_for_tooling(&self) -> Vec<RtdValidatorGenesis> {
        self.rtd_system_object()
    ...
    pub fn committee_with_network(&self) -> CommitteeWithNetworkMetadata {
        self.rtd_system_object().get_current_epoch_committee()
    }
    ...
    pub fn rtd_system_wrapper_object(&self) -> RtdSystemStateWrapper {
        get_rtd_system_state_wrapper(&self.objects())
            .expect("Rtd System State Wrapper object must always exist")
    }

    pub fn rtd_system_object(&self) -> RtdSystemState {
        get_rtd_system_state(&self.objects()).expect("Rtd System State object must always exist")
    }
    ...
    pub fn clock(&self) -> Clock {
        let clock = self
            .objects()
            .iter()
            .find(|o| o.id() == rtd_types::RTD_CLOCK_OBJECT_ID)
...
impl UnsignedGenesis {
    ...
    pub fn has_bridge_object(&self) -> bool {
        self.objects().get_object(&RTD_BRIDGE_OBJECT_ID).is_some()
    }
...
impl GenesisCeremonyParameters {
    ...
    fn default_initial_stake_subsidy_distribution_amount() -> u64 {
        // 1M Rtd
        1_000_000 * rtd_types::gas_coin::MIST_PER_RTD
    }
    ...
    pub fn to_genesis_chain_parameters(&self) -> GenesisChainParameters {
        GenesisChainParameters {
            ...
            max_validator_count: rtd_types::governance::MAX_VALIDATOR_COUNT,
            min_validator_joining_stake: rtd_types::governance::MIN_VALIDATOR_JOINING_STAKE_MIST,
            validator_low_stake_threshold:
                rtd_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST,
            validator_very_low_stake_threshold:
                rtd_types::governance::VALIDATOR_VERY_LOW_STAKE_THRESHOLD_MIST,
            validator_low_stake_grace_period:
                rtd_types::governance::VALIDATOR_LOW_STAKE_GRACE_PERIOD,
        }
    }
}
...
impl TokenDistributionSchedule {
    ...
    pub fn check_all_stake_operations_are_for_valid_validators<
        I: IntoIterator<Item = RtdAddress>,
    >(
        &self,
        validators: I,
    ) {
        ...
        let mut validators: HashMap<RtdAddress, u64> =
    ...
    #[allow(deprecated)]
    pub fn new_for_validators_with_default_allocation<I: IntoIterator<Item = RtdAddress>>(
        validators: I,
    ) -> Self {
        let mut supply = TOTAL_SUPPLY_MIST;
        let default_allocation = rtd_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
    ...
    ///
    /// All entries in a token distribution schedule must add up to 10B Rtd.
    pub fn from_csv<R: std::io::Read>(reader: R) -> Result<Self> {
        ...
        assert_eq!(
            ...
            "Token Distribution Schedule must add up to 10B Rtd",
        );
    ...
    pub fn to_csv<W: std::io::Write>(&self, writer: W) -> Result<()> {
        ...
        writer.serialize(TokenAllocation {
            recipient_address: RtdAddress::default(),
...
pub struct TokenAllocation {
    pub recipient_address: RtdAddress,
    pub amount_mist: u64,

    /// Indicates if this allocation should be staked at genesis and with which validator
    pub staked_with_validator: Option<RtdAddress>,
}
...
impl TokenDistributionScheduleBuilder {
    ...
    #[allow(deprecated)]
    pub fn default_allocation_for_validators<I: IntoIterator<Item = RtdAddress>>(
        &mut self,
        validators: I,
    ) {
        let default_allocation = rtd_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
