...
//use rtd_json_rpc::api::ExtendedApiOpenRpc;
...
use rtd_json_rpc_api::IndexerApiOpenRpc;
use rtd_json_rpc_api::MoveUtilsOpenRpc;
...
async fn main() {
    ...
    let mut open_rpc = rtd_rpc_doc(VERSION);
