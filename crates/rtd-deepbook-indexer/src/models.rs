...
use serde::Serialize;
use rtd_indexer_builder::{LIVE_TASK_TARGET_CHECKPOINT, Task};

use crate::schema::{
    balances, balances_summary, flashloans, order_fills, order_updates, pool_prices, pools,
    progress_store, proposals, rebates, stakes, rtd_error_transactions, trade_params_update, votes,
};
...
#[derive(Queryable, Selectable, Insertable, Identifiable, Debug)]
#[diesel(table_name = rtd_error_transactions, primary_key(txn_digest))]
pub struct RtdErrorTransactions {
