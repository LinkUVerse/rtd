...
use linku_service::get_linku_service;
use linku_service::metrics::start_basic_prometheus_server;
use linku_service::package_name;
use linku_service::package_version;
use linku_service::serve;
...
async fn main() -> Result<()> {
    ...
    let app = get_linku_service(package_name!(), package_version!())
