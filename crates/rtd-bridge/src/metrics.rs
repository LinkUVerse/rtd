...
pub struct BridgeMetrics {
    pub(crate) err_build_rtd_transaction: IntCounter,
    pub(crate) err_signature_aggregation: IntCounter,
    pub(crate) err_signature_aggregation_too_many_failures: IntCounter,
    pub(crate) err_rtd_transaction_submission: IntCounter,
    pub(crate) err_rtd_transaction_submission_too_many_failures: IntCounter,
    pub(crate) err_rtd_transaction_execution: IntCounter,
    ...
    pub(crate) last_synced_rtd_checkpoints: IntGaugeVec,
    pub(crate) last_finalized_eth_block: IntGauge,
    pub(crate) last_synced_eth_blocks: IntGaugeVec,

    pub(crate) rtd_watcher_received_events: IntCounter,
    pub(crate) rtd_watcher_received_actions: IntCounter,
    pub(crate) rtd_watcher_unrecognized_events: IntCounter,
    ...
    pub(crate) rtd_rpc_errors: IntCounterVec,
    ...
    pub(crate) rtd_eth_token_transfer_approved: IntCounter,
    pub(crate) rtd_eth_token_transfer_claimed: IntCounter,
    pub(crate) eth_rtd_token_transfer_approved: IntCounter,
    pub(crate) eth_rtd_token_transfer_claimed: IntCounter,
}

impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            err_build_rtd_transaction: register_int_counter_with_registry!(
                "bridge_err_build_rtd_transaction",
                "Total number of errors of building rtd transactions",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            err_rtd_transaction_submission: register_int_counter_with_registry!(
                "bridge_err_rtd_transaction_submission",
                "Total number of errors of submitting rtd transactions",
                registry,
            )
            .unwrap(),
            err_rtd_transaction_submission_too_many_failures: register_int_counter_with_registry!(
                "bridge_err_rtd_transaction_submission_too_many_failures",
                "Total number of continuous failures to submitting rtd transactions",
                registry,
            )
            .unwrap(),
            err_rtd_transaction_execution: register_int_counter_with_registry!(
                "bridge_err_rtd_transaction_execution",
                "Total number of failures of rtd transaction execution",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            rtd_watcher_received_events: register_int_counter_with_registry!(
                "bridge_rtd_watcher_received_events",
                "Total number of received events in rtd watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            rtd_watcher_received_actions: register_int_counter_with_registry!(
                "bridge_rtd_watcher_received_actions",
                "Total number of received actions in rtd watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            rtd_watcher_unrecognized_events: register_int_counter_with_registry!(
                "bridge_rtd_watcher_unrecognized_events",
                "Total number of unrecognized events in rtd watcher",
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            last_synced_rtd_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_rtd_checkpoints",
                "The latest rtd checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            rtd_rpc_errors: register_int_counter_vec_with_registry!(
                "bridge_rtd_rpc_errors",
                "Total number of errors from rtd RPC, by RPC method",
                &["method"],
                registry,
            )
            .unwrap(),
            ...
            .unwrap(),
            rtd_eth_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_rtd_eth_token_transfer_approved",
                "Total number of approved rtd to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            rtd_eth_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_rtd_eth_token_transfer_claimed",
                "Total number of claimed rtd to eth token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_rtd_token_transfer_approved: register_int_counter_with_registry!(
                "bridge_eth_rtd_token_transfer_approved",
                "Total number of approved eth to rtd token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
            eth_rtd_token_transfer_claimed: register_int_counter_with_registry!(
                "bridge_eth_rtd_token_transfer_claimed",
                "Total number of claimed eth to rtd token transfers (since metric introduced). \
                Should be used to track rates rather than absolute values.",
                registry,
            )
            .unwrap(),
