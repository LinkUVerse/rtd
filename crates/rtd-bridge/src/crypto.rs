...
mod tests {
    ...
    fn test_sign_and_verify_bridge_event_basic() -> anyhow::Result<()> {
        ...
        let mismatched_action: BridgeAction =
            get_test_rtd_to_eth_bridge_action(None, Some(2), Some(3), Some(4), None, None, None);
        ...
        let action2: BridgeAction =
            get_test_rtd_to_eth_bridge_action(None, Some(3), Some(5), Some(77), None, None, None);
    ...
    fn test_bridge_sig_verification_regression_test() {
        ...
        let action = BridgeAction::RtdToEthBridgeAction(RtdToEthBridgeAction {
            rtd_tx_digest: TransactionDigest::random(),
            rtd_tx_event_index: 0,
            rtd_bridge_event: EmittedRtdToEthTokenBridgeV1 {
                nonce: 1,
                rtd_chain_id: BridgeChainId::RtdTestnet,
                rtd_address: RtdAddress::from_str(
