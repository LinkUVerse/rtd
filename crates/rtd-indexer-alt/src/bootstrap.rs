...
pub async fn bootstrap(
    ...
    let BootstrapGenesis {
        ...
        None => {
            ...
            let rtd_system_state = get_rtd_system_state(&output_objects.as_slice())
            ...
            let stored_epoch_start = StoredEpochStart {
                epoch: 0,
                protocol_version: rtd_system_state.protocol_version() as i64,
                cp_lo: 0,
                start_timestamp_ms: rtd_system_state.epoch_start_timestamp_ms() as i64,
                reference_gas_price: rtd_system_state.reference_gas_price() as i64,
                system_state: bcs::to_bytes(&rtd_system_state)
