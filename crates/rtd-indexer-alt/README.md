...
```
postgres://postgres:postgrespw@localhost:5432/rtd_indexer_alt
```
...
diesel setup                                                                       \
    --database-url="postgres://postgres:postgrespw@localhost:5432/rtd_indexer_alt" \
    --migration-dir ../rtd-indexer-alt-schema/migrations
```
...
cargo nextest run                \
    -p rtd-indexer-alt           \
    -p rtd-indexer-alt-framework \
    -p rtd-indexer-alt-e2e-tests
```
...
```sh
cargo run --bin rtd-indexer-alt -- generate-config > indexer_alt_config.toml
```
