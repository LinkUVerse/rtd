...
use rtd_types::deny_list_v1::{CoinDenyCap, RegulatedCoinMetadata};
use rtd_types::deny_list_v2::{
...
async fn test_regulated_coin_v2_types() {
    ...
    let deny_list_object_init_version = env.get_latest_object_ref(&RTD_DENY_LIST_OBJECT_ID).await.1;
