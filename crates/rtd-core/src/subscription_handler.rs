...
use rtd_json_rpc_types::{
    EffectsWithInput, EventFilter, RtdTransactionBlockEffects, RtdTransactionBlockEvents,
    TransactionFilter,
};
use rtd_json_rpc_types::{RtdEvent, RtdTransactionBlockEffectsAPI};
...
pub struct SubscriptionHandler {
    event_streamer: Streamer<RtdEvent, RtdEvent, EventFilter>,
    transaction_streamer: Streamer<EffectsWithInput, RtdTransactionBlockEffects, TransactionFilter>,
}
...
impl SubscriptionHandler {
    ...
    pub fn subscribe_events(&self, filter: EventFilter) -> impl Stream<Item = RtdEvent> + use<> {
    ...
    ) -> impl Stream<Item = RtdTransactionBlockEffects> + use<> {
