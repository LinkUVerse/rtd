...
pub struct CheckpointExecutorMetrics {
    ...
    pub checkpoint_contents_age_ms: LinkUHistogram,
    pub last_executed_checkpoint_age: Histogram,
    // TODO: delete once users are migrated to non-LinkU histogram.
    pub last_executed_checkpoint_age_ms: LinkUHistogram,
...
impl CheckpointExecutorMetrics {
    pub fn new(registry: &Registry) -> Arc<Self> {
        let this = Self {
            ...
            .unwrap(),
            checkpoint_contents_age_ms: LinkUHistogram::new_in_registry(
            ...
            .unwrap(),
            last_executed_checkpoint_age_ms: LinkUHistogram::new_in_registry(
