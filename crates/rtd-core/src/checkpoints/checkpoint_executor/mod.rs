...
impl CheckpointExecutor {
    ...
    pub async fn run_epoch(self, run_with_range: Option<RunWithRange>) -> StopReason {
        let _metrics_scope = linku_metrics::monitored_scope("CheckpointExecutor::run_epoch");
        ...
        let concurrency = std::env::var("RTD_CHECKPOINT_EXECUTION_MAX_CONCURRENCY")
            .ok()
...
impl CheckpointExecutor {
    ...
    async fn execute_checkpoint(
        ...
        let _parallel_step_guard =
            linku_metrics::monitored_scope("CheckpointExecutor::parallel_step");
    ...
    async fn verify_locally_built_checkpoint(
        ...
        let state_hasher = {
            let _metrics_scope =
                linku_metrics::monitored_scope("CheckpointExecutor::notify_read_state_hasher");
            self.epoch_store
    ...
    async fn execute_transactions_from_synced_checkpoint(
        ...
        let _scope = linku_metrics::monitored_scope("CheckpointExecutor::finalize_checkpoint");
