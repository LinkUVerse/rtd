...
pub struct CheckpointMetrics {
    ...
    // TODO: delete once users are migrated to non-LinkU histogram.
    pub checkpoint_creation_latency_ms: LinkUHistogram,
    ...
    // TODO: delete once users are migrated to non-LinkU histogram.
    pub last_created_checkpoint_age_ms: LinkUHistogram,
    pub last_certified_checkpoint_age: Histogram,
    // TODO: delete once users are migrated to non-LinkU histogram.
    pub last_certified_checkpoint_age_ms: LinkUHistogram,
}
...
impl CheckpointMetrics {
    pub fn new(registry: &Registry) -> Arc<Self> {
        let this = Self {
            ...
            last_created_checkpoint_age_ms: LinkUHistogram::new_in_registry(
            ...
            last_certified_checkpoint_age_ms: LinkUHistogram::new_in_registry(
            ...
            checkpoint_creation_latency_ms: LinkUHistogram::new_in_registry(
