...
impl CommitteeStore {
    ...
    pub fn init_genesis_committee(&self, genesis_committee: Committee) -> RtdResult {
    ...
    pub fn insert_new_committee(&self, new_committee: &Committee) -> RtdResult {
    ...
    pub fn get_committee(&self, epoch_id: &EpochId) -> RtdResult<Option<Arc<Committee>>> {
    ...
    pub fn get_latest_committee(&self) -> RtdResult<Committee> {
        Ok(self
            .tables
            .committee_map
    ...
    // todo - make use of cache or remove this method
    pub fn get_or_latest_committee(&self, epoch: Option<EpochId>) -> RtdResult<Committee> {
        Ok(match epoch {
            Some(epoch) => self
                .get_committee(&epoch)?
                .ok_or(RtdErrorKind::MissingCommitteeAtEpoch(epoch))
    ...
    fn database_is_empty(&self) -> RtdResult<bool> {
        Ok(self
            .tables
            .committee_map
            .safe_iter()
