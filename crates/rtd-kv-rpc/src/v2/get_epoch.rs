...
use rtd_rpc::proto::rtd::rpc::v2::ProtocolConfig as RpcProtocolConfig;
use rtd_rpc::proto::rtd::rpc::v2::{GetEpochRequest, GetEpochResponse};
use rtd_rpc_api::{
    ErrorReason,
...
pub async fn get_epoch(
    ...
    chain: Chain,
) -> rtd_rpc_api::Result<GetEpochResponse> {
    let read_mask = {
