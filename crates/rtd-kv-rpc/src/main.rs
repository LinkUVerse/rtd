...
async fn main() -> Result<()> {
    ...
    let server_version = Some(ServerVersion::new("rtd-kv-rpc", VERSION));
    let registry_service = linku_metrics::start_prometheus_server(
    ...
    let reflection_v1 = tonic_reflection::server::Builder::configure()
        .register_encoded_file_descriptor_set(
            rtd_rpc_api::proto::google::protobuf::FILE_DESCRIPTOR_SET,
        )
        .register_encoded_file_descriptor_set(rtd_rpc_api::proto::google::rpc::FILE_DESCRIPTOR_SET)
        .register_encoded_file_descriptor_set(rtd_rpc::proto::rtd::rpc::v2::FILE_DESCRIPTOR_SET)
        .build_v1()?;
    ...
    builder
        ...
        .add_service(
            rtd_rpc::proto::rtd::rpc::v2::ledger_service_server::LedgerServiceServer::new(server),
        )
