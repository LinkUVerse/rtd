...
pub struct RpcConfig {
    ...
    /// Configuration for RtdNS related RPC methods.
    ...
    pub package_resolver: rtd_package_resolver::Limits,
}
...
pub struct NameServiceLayer {
    pub package_address: Option<RtdAddress>,
...
impl RpcLayer {
    /// Generate an example configuration, rtdtable for demonstrating the fields available to
    /// configure.
    pub fn example() -> Self {
        Self {
...
impl PackageResolverLayer {
    pub fn finish(self) -> rtd_package_resolver::Limits {
...
impl Default for NodeConfig {
    fn default() -> Self {
        Self {
            header_value: "rtd-indexer-alt-jsonrpc".to_string(),
