...
#[graphql(
    ...
    field(
        ...
        desc = "The RTD returned to the sponsor or sender of the transaction that modifies or deletes this object."
    ),
    field(
...
impl Object {
    ...
    fn from_stored_version(
        ...
        let address = Address::with_address(
            scope,
            NativeRtdAddress::from_bytes(stored.object_id)
                .context("Failed to deserialize RtdAddress")?,
        );
