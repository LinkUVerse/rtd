...
use rtd_types::rtd_system_state::rtd_system_state_inner_v1::SystemParametersV1;
use rtd_types::rtd_system_state::rtd_system_state_inner_v2::SystemParametersV2;
