...
use rtd_types::balance_change::derive_balance_changes;
use tokio::sync::RwLock;

use rtd_json_rpc_types::BalanceChange;
...
use rtd_types::transaction::InputObjectKind;
    ...
    Ok(
        derive_balance_changes(effects, &input_coins, &mutated_coins)
            ...
            .map(|change| BalanceChange {
                owner: rtd_types::object::Owner::AddressOwner(change.address),
