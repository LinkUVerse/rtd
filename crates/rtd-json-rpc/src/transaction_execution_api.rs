...
use rtd_json_rpc_api::{JsonRpcMetrics, WriteApiOpenRpc, WriteApiServer};
use rtd_json_rpc_types::{
    DevInspectArgs, DevInspectResults, DryRunTransactionBlockResponse, RtdTransactionBlock,
...
impl TransactionExecutionApi {
    ...
    > {
        ...
        let transaction = if opts.show_input {
            ...
            Some(RtdTransactionBlock::try_from(
                txn.data().clone(),
    ...
    ) -> Result<RtdTransactionBlockResponse, Error> {
        let request_type =
    ...
    async fn handle_post_orchestration(
        ...
        transaction: Option<RtdTransactionBlock>,
...
impl RtdRpcModule for TransactionExecutionApi {
