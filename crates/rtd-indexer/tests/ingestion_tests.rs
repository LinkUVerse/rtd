...
use rtd_indexer::errors::IndexerError;
use rtd_indexer::handlers::TransactionObjectChangesToCommit;
use rtd_indexer::models::{
    checkpoints::StoredCheckpoint, objects::StoredObject, objects::StoredObjectSnapshot,
    transactions::StoredTransaction,
};
use rtd_indexer::schema::{checkpoints, objects, objects_snapshot, transactions};
use rtd_indexer::store::indexer_store::IndexerStore;
use rtd_indexer::test_utils::{
    set_up, set_up_with_start_and_end_checkpoints, wait_for_checkpoint, wait_for_objects_snapshot,
};
use rtd_indexer::types::EventIndex;
use rtd_indexer::types::IndexedDeletedObject;
use rtd_indexer::types::IndexedObject;
use rtd_indexer::types::TxIndex;
...
pub async fn test_transaction_table() -> Result<(), IndexerError> {
    ...
    let transfer_recipient = RtdAddress::random_for_testing_only();
...
pub async fn test_object_type() -> Result<(), IndexerError> {
    ...
    assert_eq!(
        ...
        Some(RTD_FRAMEWORK_PACKAGE_ID.to_vec())
    );
