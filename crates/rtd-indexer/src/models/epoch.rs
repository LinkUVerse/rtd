...
use rtd_json_rpc_types::{EndOfEpochInfo, EpochInfo};
...
impl StartOfEpochUpdate {
    pub fn new(
        new_system_state_summary: RtdSystemStateSummary,
...
impl StoredEpochInfo {
    pub fn get_json_system_state_summary(&self) -> Result<RtdSystemStateSummary, IndexerError> {
