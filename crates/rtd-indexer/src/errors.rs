...
use rtd_types::base_types::ObjectIDParseError;
use rtd_types::error::{RtdError, RtdObjectResponseError, UserInputError};
...
pub enum IndexerError {
    ...
    JsonRpcServerError(#[from] rtd_json_rpc::error::Error),
    ...
    #[error(transparent)]
    ObjectResponseError(#[from] RtdObjectResponseError),
...
impl From<rtd_types::error::RtdErrorKind> for IndexerError {
    fn from(e: rtd_types::error::RtdErrorKind) -> Self {
        IndexerError::RtdError(RtdError::from(e))
    }
}
