...
use clap::Parser;
use rtd_indexer::backfill::backfill_runner::BackfillRunner;
use rtd_indexer::config::Command;
use rtd_indexer::database::ConnectionPool;
use rtd_indexer::db::setup_postgres::clear_database;
use rtd_indexer::db::{
    check_db_migration_consistency, check_prunable_tables_valid, reset_database, run_migrations,
};
use rtd_indexer::indexer::Indexer;
use rtd_indexer::metrics::{
...
async fn main() -> anyhow::Result<()> {
    let opts = rtd_indexer::config::IndexerConfig::parse();
