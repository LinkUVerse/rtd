...
use rtd_json_rpc::ObjectProvider;
use rtd_json_rpc::get_balance_changes_from_effect;
use rtd_json_rpc::get_object_changes;
...
impl TxChangesProcessor {
    ...
    pub(crate) async fn get_changes(
        ...
        Vec<rtd_json_rpc_types::BalanceChange>,
...
// This is a struct that is used to extract RtdSystemState and its dynamic children
...
impl rtd_types::storage::ObjectStore for EpochEndIndexingObjectStore<'_> {
