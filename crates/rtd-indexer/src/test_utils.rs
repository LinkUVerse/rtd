...
use linku_metrics::init_metrics;
...
use rtd_pg_db::temp::{TempDb, get_available_port};
...
#[derive(Clone)]
pub struct RtdTransactionBlockResponseBuilder<'a> {
    response: RtdTransactionBlockResponse,
    full_response: &'a RtdTransactionBlockResponse,
}

impl<'a> RtdTransactionBlockResponseBuilder<'a> {
    pub fn new(full_response: &'a RtdTransactionBlockResponse) -> Self {
        Self {
            response: RtdTransactionBlockResponse::default(),
            full_response,
        }
    }

    pub fn with_input(mut self) -> Self {
        self.response = RtdTransactionBlockResponse {
    ...
    pub fn build(self) -> RtdTransactionBlockResponse {
...
pub async fn set_up(
    ...
    let server_handle = tokio::spawn(async move {
        rtd_rpc_api::RpcService::new(sim)
