...
use rtd_json_rpc_api::{ExtendedApiServer, QUERY_MAX_RESULT_LIMIT_CHECKPOINTS, validate_limit};
use rtd_json_rpc_types::{
    CheckpointedObjectID, EpochInfo, EpochPage, Page, QueryObjectsPage, RtdObjectResponseQuery,
};
...
impl RtdRpcModule for ExtendedApi {
    fn rpc(self) -> RpcModule<Self> {
        self.into_rpc()
    }

    fn rpc_doc_module() -> Module {
        rtd_json_rpc_api::ExtendedApiOpenRpc::module_doc()
    }
}
