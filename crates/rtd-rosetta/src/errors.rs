...
use rtd_rpc::proto::rtd::rpc::v2::ExecutionError;
use rtd_types::error::{RtdError, RtdErrorKind};

use crate::types::{BlockHash, OperationType, PublicKey, RtdEnv};
use strum::EnumProperty;
use strum_macros::Display;
use strum_macros::EnumDiscriminants;
use thiserror::Error;

/// Rtd-Rosetta specific error types.
/// This contains all the errors returns by the rtd-rosetta server.
...
impl From<RtdErrorKind> for Error {
    fn from(e: RtdErrorKind) -> Self {
        Error::RtdError(RtdError::from(e))
    }
}
