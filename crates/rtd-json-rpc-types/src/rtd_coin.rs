...
impl TryFrom<Object> for RtdCoinMetadata {
    type Error = RtdError;
...
impl From<CoinMetadata> for RtdCoinMetadata {
...
impl From<coin_registry::Currency> for RtdCoinMetadata {
