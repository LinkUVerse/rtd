...
pub use rtd_coin::*;
pub use rtd_event::*;
pub use rtd_extended::*;
pub use rtd_governance::*;
pub use rtd_move::*;
pub use rtd_object::*;
...
pub struct DynamicFieldInfo {
    pub name: rtd_types::dynamic_field::DynamicFieldName,
    #[serde(flatten)]
    pub bcs_name: BcsName,
    pub type_: rtd_types::dynamic_field::DynamicFieldType,
    pub object_type: String,
    pub object_id: ObjectID,
    pub version: rtd_types::base_types::SequenceNumber,
    pub digest: rtd_types::digests::ObjectDigest,
}

impl From<rtd_types::dynamic_field::DynamicFieldInfo> for DynamicFieldInfo {
    fn from(
        rtd_types::dynamic_field::DynamicFieldInfo {
            name,
            bcs_name,
            type_,
            object_type,
