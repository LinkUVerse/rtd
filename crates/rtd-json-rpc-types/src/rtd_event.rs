...
pub type EventPage = Page<RtdEvent, EventID>;
...
impl From<EventEnvelope> for RtdEvent {
...
impl From<RtdEvent> for Event {
    fn from(val: RtdEvent) -> Self {
        Event {
...
impl Filter<RtdEvent> for EventFilter {
    fn matches(&self, item: &RtdEvent) -> bool {
