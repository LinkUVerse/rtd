...
pub struct RtdClientConfig {
    ...
    pub active_address: Option<RtdAddress>,
}

impl RtdClientConfig {
    ...
    pub fn get_env(&self, alias: &Option<String>) -> Option<&RtdEnv> {
    ...
    pub fn add_env(&mut self, env: RtdEnv) {
        if !self
            .envs
            .iter()
...
impl RtdEnv {
    ...
    pub fn localnet() -> Self {
        Self {
            ...
            rpc: RTD_LOCAL_NETWORK_URL.into(),
            ws: None,
            basic_auth: None,
            chain_id: None,
        }
...
impl Config for RtdClientConfig {}

impl Display for RtdClientConfig {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let mut writer = String::new();
