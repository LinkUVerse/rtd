...
use crate::{RTD_FRAMEWORK_ADDRESS, base_types::ObjectID};
...
pub const RESOLVED_RTD_ID: (&AccountAddress, &IdentStr, &IdentStr) =
    (&RTD_FRAMEWORK_ADDRESS, OBJECT_MODULE_NAME, ID_STRUCT_NAME);

/// Rust version of the Move rtd::object::Info type
#[derive(Debug, Serialize, Deserialize, JsonSchema, Clone, Eq, PartialEq)]
pub struct UID {
    pub id: ID,
}

/// Rust version of the Move rtd::object::ID type
#[derive(Debug, Serialize, Deserialize, JsonSchema, Clone, Eq, PartialEq)]
#[serde(transparent)]
pub struct ID {
    pub bytes: ObjectID,
