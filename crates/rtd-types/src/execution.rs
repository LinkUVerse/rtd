...
use crate::{
    MoveTypeTagTrait, RTD_SYSTEM_ADDRESS,
...
const RTD_SYSTEM_STATE_INNER_MODULE: &str = "rtd_system_state_inner";
...
/// Used by rtd-execution v1 and above, to capture the execution results from Move.
...
impl ExecutionResultsV2 {
    ...
    pub fn merge_results(&mut self, new_results: Self) {
        ...
        self.settlement_input_rtd += new_results.settlement_input_rtd;
        self.settlement_output_rtd += new_results.settlement_output_rtd;
    }
...
impl MoveTypeTagTrait for ExecutionTimeObservationChunkKey {
    fn get_type_tag() -> TypeTag {
        TypeTag::Struct(Box::new(StructTag {
            ...
            module: Identifier::new(RTD_SYSTEM_STATE_INNER_MODULE).unwrap(),
