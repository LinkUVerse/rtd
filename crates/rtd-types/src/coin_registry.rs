...
use crate::{
    RTD_COIN_REGISTRY_OBJECT_ID, RTD_FRAMEWORK_ADDRESS,
...
/// Rust representation of `rtd::coin_registry::CurrencyKey<T>`.
#[derive(Serialize, Deserialize, Copy, Clone, Default, PartialEq, Eq)]
pub struct CurrencyKey(bool);

/// Rust representation of `rtd::coin_registry::Currency<phantom T>`.
...
/// Rust representation of `rtd::coin_registry::SupplyState<phantom T>`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `rtd::coin_registry::RegulatedState`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `rtd::coin_registry::MetadataCapState`.
#[derive(Serialize, Deserialize)]
...
/// Rust representation of `rtd::coin_registry::ExtraField`.
#[derive(Serialize, Deserialize)]
...
impl Currency {
    /// Derive the ObjectID for `rtd::coin_registry::Currency<$coin_type>`.
    ...
    /// Is this `StructTag` a `rtd::coin_registry::Currency<...>`?
...
pub fn get_coin_registry_obj_initial_shared_version(
    ...
    Ok(object_store
        .get_object(&RTD_COIN_REGISTRY_OBJECT_ID)
