...
use rtd_rpc::proto::TryFromProtoError;
    ...
    fn merge(&mut self, source: &crate::full_checkpoint_content::Checkpoint, mask: &FieldMaskTree) {
            ...
            .and_then(|submask| submask.subtree(ObjectSet::OBJECTS_FIELD))
        {
            let set = source
                .object_set
                .iter()
                .map(|o| rtd_rpc::proto::rtd::rpc::v2::Object::merge_from(o, &submask))
                .collect();
            ...
            self.transactions = source
                ...
                .map(|t| {
                    ...
                    transaction.timestamp = submask
                        ...
                        .then(|| rtd_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
                    transaction
                })
                .collect();
        }
...
impl Merge<crate::messages_checkpoint::CheckpointSummary> for CheckpointSummary {
    fn merge(
        ...
        if mask.contains(Self::TIMESTAMP_FIELD) {
            self.timestamp = Some(rtd_rpc::proto::timestamp_ms_to_proto(timestamp_ms));
        }
...
impl From<crate::rtd_system_state::RtdSystemState> for SystemState {
    fn from(value: crate::rtd_system_state::RtdSystemState) -> Self {
        match value {
            crate::rtd_system_state::RtdSystemState::V1(v1) => v1.into(),
            crate::rtd_system_state::RtdSystemState::V2(v2) => v2.into(),
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::RtdSystemStateInnerV1>
    for SystemState
{
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::RtdSystemStateInnerV1 {
            epoch,
            protocol_version,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v2::RtdSystemStateInnerV2>
    for SystemState
{
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v2::RtdSystemStateInnerV2 {
            epoch,
            protocol_version,
            system_state_version,
            validators,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::StakeSubsidyV1> for StakeSubsidy {
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::StakeSubsidyV1 {
            balance,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::SystemParametersV1>
    for SystemParameters
{
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::SystemParametersV1 {
            epoch_duration_ms,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v2::SystemParametersV2>
    for SystemParameters
{
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v2::SystemParametersV2 {
            epoch_duration_ms,
            stake_subsidy_start_epoch,
            min_validator_count,
            max_validator_count,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::StorageFundV1> for StorageFund {
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::StorageFundV1 {
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::ValidatorSetV1> for ValidatorSet {
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::ValidatorSetV1 {
            total_stake,
            active_validators,
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::StakingPoolV1> for StakingPool {
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::StakingPoolV1 {
            id,
            activation_epoch,
            deactivation_epoch,
            rtd_balance,
        ...
        message.rtd_balance = Some(rtd_balance);
        ...
        message.pending_total_rtd_withdraw = Some(pending_total_rtd_withdraw);
...
impl From<crate::rtd_system_state::rtd_system_state_inner_v1::ValidatorV1> for Validator {
    fn from(
        crate::rtd_system_state::rtd_system_state_inner_v1::ValidatorV1 {
            metadata:
                crate::rtd_system_state::rtd_system_state_inner_v1::ValidatorMetadataV1 {
                    rtd_address,
        ...
        message.address = Some(rtd_address.to_string());
...
impl From<crate::execution_status::ExecutionFailureStatus> for ExecutionError {
    fn from(value: crate::execution_status::ExecutionFailureStatus) -> Self {
        ...
        let kind = match value {
            ...
            E::RtdMoveVerificationError => ExecutionErrorKind::RtdMoveVerificationError,
            ...
            E::RtdMoveVerificationTimedout => ExecutionErrorKind::RtdMoveVerificationTimedout,
    ...
    for crate::crypto::AuthorityQuorumSignInfo<T>
{
    ...
    fn try_from(value: &ValidatorAggregatedSignature) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            signers_map: crate::rtd_serde::deserialize_rtd_bitmap(value.bitmap())
...
impl From<&crate::zk_login_authenticator::ZkLoginAuthenticator> for ZkLoginAuthenticator {
    fn from(value: &crate::zk_login_authenticator::ZkLoginAuthenticator) -> Self {
        ...
        rtd_sdk_types::ZkLoginAuthenticator::try_from(value.clone())
            .map(Into::into)
            .ok()
            .unwrap_or(message)
    }
...
impl From<&crate::crypto::ZkLoginPublicIdentifier> for ZkLoginPublicIdentifier {
    fn from(value: &crate::crypto::ZkLoginPublicIdentifier) -> Self {
        //TODO implement this without going through the sdk type
        rtd_sdk_types::ZkLoginPublicIdentifier::try_from(value.to_owned())
            .map(|id| (&id).into())
            .ok()
            .unwrap_or_default()
    }
...
impl From<crate::messages_consensus::ConsensusCommitPrologue> for ConsensusCommitPrologue {
    fn from(value: crate::messages_consensus::ConsensusCommitPrologue) -> Self {
        ...
        message.commit_timestamp = Some(rtd_rpc::proto::timestamp_ms_to_proto(
...
impl From<crate::messages_consensus::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
        ...
        message.commit_timestamp = Some(rtd_rpc::proto::timestamp_ms_to_proto(commit_timestamp_ms));
...
impl From<crate::transaction::ChangeEpoch> for ChangeEpoch {
    fn from(value: crate::transaction::ChangeEpoch) -> Self {
        ...
        message.epoch_start_timestamp = Some(rtd_rpc::proto::timestamp_ms_to_proto(
...
impl From<&crate::coin_registry::Currency> for CoinMetadata {
    fn from(value: &crate::coin_registry::Currency) -> Self {
        ...
        metadata.id = Some(rtd_sdk_types::Address::from(value.id.into_bytes()).to_string());
        ...
        match &value.metadata_cap_id {
            crate::coin_registry::MetadataCapState::Claimed(id) => {
                ...
                metadata.metadata_cap_id = Some(rtd_sdk_types::Address::from(*id).to_string());
            }
            crate::coin_registry::MetadataCapState::Unclaimed => {
...
impl From<crate::coin::CoinMetadata> for CoinMetadata {
    fn from(value: crate::coin::CoinMetadata) -> Self {
        let mut metadata = CoinMetadata::default();
        metadata.id = Some(rtd_sdk_types::Address::from(value.id.id.bytes).to_string());
        metadata.decimals = Some(value.decimals.into());
...
impl From<crate::coin::TreasuryCap> for CoinTreasury {
    fn from(value: crate::coin::TreasuryCap) -> Self {
        ...
        treasury.id = Some(rtd_sdk_types::Address::from(value.id.id.bytes).to_string());
    ...
    fn from(value: &crate::coin_registry::RegulatedState) -> Self {
        ...
        match value {
            crate::coin_registry::RegulatedState::Regulated {
                ...
                regulated.deny_cap_object = Some(rtd_sdk_types::Address::from(*cap).to_string());
...
impl From<crate::coin::RegulatedCoinMetadata> for RegulatedCoinMetadata {
    fn from(value: crate::coin::RegulatedCoinMetadata) -> Self {
        ...
        message.id = Some(rtd_sdk_types::Address::from(value.id.id.bytes).to_string());
        message.coin_metadata_object =
            Some(rtd_sdk_types::Address::from(value.coin_metadata_object.bytes).to_string());
        message.deny_cap_object =
            Some(rtd_sdk_types::Address::from(value.deny_cap_object.bytes).to_string());
