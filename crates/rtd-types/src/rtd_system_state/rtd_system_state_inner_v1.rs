...
use super::epoch_start_rtd_system_state::EpochStartValidatorInfoV1;
use super::rtd_system_state_summary::{RtdSystemStateSummary, RtdValidatorSummary};
use super::{AdvanceEpochParams, RtdSystemStateTrait, get_validators_from_table_vec};
use crate::balance::Balance;
use crate::base_types::{ObjectID, RtdAddress};
...
/// Rust version of the Move rtd::rtd_system::SystemParameters type
...
impl VerifiedValidatorMetadataV1 {
    pub fn rtd_pubkey_bytes(&self) -> AuthorityPublicKeyBytes {
...
impl ValidatorMetadataV1 {
    ...
    pub fn verify(&self) -> Result<VerifiedValidatorMetadataV1, u64> {
        ...
        verify_proof_of_possession(&pop, &protocol_pubkey, self.rtd_address)
            .map_err(|_| E_METADATA_INVALID_POP)?;
...
/// Rust version of the Move rtd::validator::Validator type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
impl ValidatorV1 {
    ...
    pub fn into_rtd_validator_summary(self) -> RtdValidatorSummary {
        let Self {
            metadata:
                ValidatorMetadataV1 {
                    rtd_address,
            ...
            staking_pool:
                StakingPoolV1 {
                    ...
                    rtd_balance: staking_pool_rtd_balance,
                    rewards_pool,
                    pool_token_balance,
                    exchange_rates:
                        Table {
...
/// Rust version of the Move rtd_system::staking_pool::StakingPool type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct StakingPoolV1 {
    ...
    pub pending_total_rtd_withdraw: u64,
    pub pending_pool_token_withdraw: u64,
    pub extra_fields: Bag,
}

/// Rust version of the Move rtd_system::validator_set::ValidatorSet type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct ValidatorSetV1 {
    ...
    pub at_risk_validators: VecMap<RtdAddress, u64>,
    pub extra_fields: Bag,
}

/// Rust version of the Move rtd_system::storage_fund::StorageFund type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
...
/// Rust version of the Move rtd_system::rtd_system::RtdSystemStateInner type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct RtdSystemStateInnerV1 {
    pub epoch: u64,
    ...
    pub validator_report_records: VecMap<RtdAddress, VecSet<RtdAddress>>,
...
impl RtdSystemStateTrait for RtdSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn get_current_epoch_committee(&self) -> CommitteeWithNetworkMetadata {
        let validators = self
            ...
            .map(|validator| {
                ...
                let name = verified_metadata.rtd_pubkey_bytes();
                (
                    name,
                    (
    ...
    fn into_rtd_system_state_summary(self) -> RtdSystemStateSummary {
        // If you are making any changes to RtdSystemStateV1 or any of its dependent types before
        // mainnet, please also update RtdSystemStateSummary and its corresponding TS type.
...
/// Rust version of the Move rtd_system::validator_cap::UnverifiedValidatorOperationCap type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct UnverifiedValidatorOperationCapV1 {
    pub id: ObjectID,
    pub authorizer_validator_address: RtdAddress,
}
