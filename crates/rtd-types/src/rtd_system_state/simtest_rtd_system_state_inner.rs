...
use crate::rtd_system_state::rtd_system_state_summary::{
...
pub struct SimTestRtdSystemStateInnerV1 {
    pub epoch: u64,
...
impl RtdSystemStateTrait for SimTestRtdSystemStateInnerV1 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
    ...
    fn into_rtd_system_state_summary(self) -> RtdSystemStateSummary {
        RtdSystemStateSummary::default()
    }
}

#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestRtdSystemStateInnerShallowV2 {
...
impl RtdSystemStateTrait for SimTestRtdSystemStateInnerShallowV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
...
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct SimTestRtdSystemStateInnerDeepV2 {
    pub new_dummy_field: u64,
    pub epoch: u64,
    pub protocol_version: u64,
    pub system_state_version: u64,
...
impl RtdSystemStateTrait for SimTestRtdSystemStateInnerDeepV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
