...
use super::rtd_system_state_inner_v1::ValidatorV1;
use super::rtd_system_state_summary::{RtdSystemStateSummary, RtdValidatorSummary};
use super::{AdvanceEpochParams, RtdSystemStateTrait};
...
/// Rust version of the Move rtd_system::rtd_system::RtdSystemStateInnerV2 type
#[derive(Debug, Serialize, Deserialize, Clone, Eq, PartialEq)]
pub struct RtdSystemStateInnerV2 {
    pub epoch: u64,
...
impl RtdSystemStateTrait for RtdSystemStateInnerV2 {
    fn epoch(&self) -> u64 {
        self.epoch
    }
