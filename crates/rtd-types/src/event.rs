...
use crate::base_types::{ObjectID, RtdAddress, TransactionDigest};
...
/// A universal Rtd event type encapsulating different types of events
...
impl Event {
    ...
    pub fn is_system_epoch_info_event(&self) -> bool {
        self.type_.address == RTD_SYSTEM_ADDRESS
            && self.type_.module.as_ident_str() == ident_str!("rtd_system_state_inner")
