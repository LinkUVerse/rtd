...
mod checked {
    ...
    use crate::gas::{self, GasCostSummary, GasUsageReport, RtdGasStatusAPI};
    ...
    /// A list of constant costs of various operations in Rtd.
    pub struct RtdCostTable {
    ...
    impl std::fmt::Debug for RtdCostTable {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            // TODO: dump the fields.
            write!(f, "RtdCostTable(...)")
        }
    }
    ...
    pub struct PerObjectStorage {
        ...
        /// storage_rebate is the storage rebate (in Rtd) for in this object.
    ...
    impl RtdGasStatus {
        ...
        pub(crate) fn new_with_budget(
            ...
            let rtd_cost_table = RtdCostTable::new(config, gas_price);
            let gas_rounding_step = config.gas_rounding_step_as_option();
            Self::new(
                GasStatus::new(
                    rtd_cost_table.execution_cost_table.clone(),
                    computation_budget,
                    gas_price,
        ...
        pub fn new_unmetered() -> RtdGasStatus {
            Self::new(
    ...
    impl RtdGasStatusAPI for RtdGasStatus {
