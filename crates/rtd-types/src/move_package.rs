...
use crate::{
    ...
    crypto::DefaultHash,
    error::{ExecutionError, ExecutionErrorKind, RtdErrorKind, RtdResult},
    id::{ID, UID},
...
/// Rust representation of upgrade policy constants in `rtd::package`.
#[repr(u8)]
...
/// Rust representation of `rtd::package::UpgradeCap`.
...
/// Rust representation of `rtd::package::UpgradeTicket`.
#[derive(Debug, Serialize, Deserialize)]
...
/// Rust representation of `rtd::package::UpgradeReceipt`.
#[derive(Debug, Serialize, Deserialize)]
...
impl MovePackage {
    ...
    pub fn normalize<S: Hash + Eq + Clone + ToString, Pool: normalized::StringPool<String = S>>(
        ...
        binary_config: &BinaryConfig,
        include_code: bool,
    ) -> RtdResult<BTreeMap<String, normalized::Module<S>>> {
