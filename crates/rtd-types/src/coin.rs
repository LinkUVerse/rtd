...
pub const RESOLVED_COIN_STRUCT: (&AccountAddress, &IdentStr, &IdentStr) =
    (&RTD_FRAMEWORK_ADDRESS, COIN_MODULE_NAME, COIN_STRUCT_NAME);
...
// Rust version of the Move rtd::coin::TreasuryCap type
...
impl TreasuryCap {
    ...
    pub fn from_bcs_bytes(content: &[u8]) -> Result<Self, RtdError> {
...
// Rust version of the Move rtd::coin::CoinMetadata type
#[derive(Debug, Serialize, Deserialize, Clone, JsonSchema, Eq, PartialEq)]
...
// Rust version of the Move rtd::coin::RegulatedCoinMetadata type
