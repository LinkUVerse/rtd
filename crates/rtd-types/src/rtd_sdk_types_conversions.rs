...
//! Module for conversions between rtd-core types and rtd-sdk types
//!
...
impl From<crate::base_types::RtdAddress> for Address {
    fn from(value: crate::base_types::RtdAddress) -> Self {
        Self::new(value.to_inner())
    }
}

impl From<Address> for crate::base_types::RtdAddress {
    ...
    fn from(value: crate::effects::AccumulatorWriteV1) -> Self {
        let operation = match value.operation {
            crate::effects::AccumulatorOperation::Merge => {
                rtd_sdk_types::AccumulatorOperation::Merge
            }
            crate::effects::AccumulatorOperation::Split => {
                rtd_sdk_types::AccumulatorOperation::Split
            }
        };
        Self::new(
...
impl From<ExecutionError> for crate::execution_status::ExecutionFailureStatus {
    fn from(value: ExecutionError) -> Self {
        match value {
            ...
            ExecutionError::RtdMoveVerificationError => Self::RtdMoveVerificationError,
            ...
            ExecutionError::RtdMoveVerificationTimedout => Self::RtdMoveVerificationTimedout,
...
impl TryFrom<crate::crypto::Signature> for SimpleSignature {
    ...
    fn try_from(value: crate::crypto::Signature) -> Result<Self, Self::Error> {
        match value {
            crate::crypto::Signature::Ed25519RtdSignature(ed25519_rtd_signature) => Self::Ed25519 {
                signature: Ed25519Signature::from_bytes(ed25519_rtd_signature.signature_bytes())?,
                public_key: Ed25519PublicKey::from_bytes(ed25519_rtd_signature.public_key_bytes())?,
            },
            crate::crypto::Signature::Secp256k1RtdSignature(secp256k1_rtd_signature) => {
                Self::Secp256k1 {
                    signature: Secp256k1Signature::from_bytes(
                        secp256k1_rtd_signature.signature_bytes(),
                    )?,
                    public_key: Secp256k1PublicKey::from_bytes(
                        secp256k1_rtd_signature.public_key_bytes(),
                    )?,
                }
            }

            crate::crypto::Signature::Secp256r1RtdSignature(secp256r1_rtd_signature) => {
                Self::Secp256r1 {
                    signature: Secp256r1Signature::from_bytes(
                        secp256r1_rtd_signature.signature_bytes(),
                    )?,
                    public_key: Secp256r1PublicKey::from_bytes(
                        secp256r1_rtd_signature.public_key_bytes(),
                    )?,
                }
            }
        }
