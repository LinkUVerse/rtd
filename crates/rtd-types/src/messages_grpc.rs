...
use linku_metrics::TX_TYPE_SHARED_OBJ_TX;
use linku_metrics::TX_TYPE_SINGLE_WRITER_TX;
...
pub struct ObjectInfoResponse {
    ...
    /// This should be only used for debugging purpose, such as from rtd-tool. No prod clients should
    /// rely on it.
...
impl SubmitTxRequest {
    pub fn into_raw(&self) -> Result<RawSubmitTxRequest, RtdError> {
...
pub enum WaitForEffectsResponse {
    ...
    Rejected {
        ...
        error: Option<crate::error::RtdError>,
    },
...
impl TryFrom<RawExecutedData> for ExecutedData {
    ...
    fn try_from(value: RawExecutedData) -> Result<Self, Self::Error> {
        let effects = bcs::from_bytes(&value.effects).map_err(|err| {
            crate::error::RtdErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResult> for SubmitTxResult {
    ...
    fn try_from(value: RawSubmitTxResult) -> Result<Self, Self::Error> {
        match value.inner {
            ...
            None => Err(crate::error::RtdErrorKind::GrpcMessageDeserializeError {
...
impl TryFrom<RawSubmitTxResponse> for SubmitTxResponse {
    ...
    fn try_from(value: RawSubmitTxResponse) -> Result<Self, Self::Error> {
        ...
        if value.results.len() != 1 {
            return Err(crate::error::RtdErrorKind::GrpcMessageDeserializeError {
        ...
        let results = value
            ...
            .collect::<Result<Vec<SubmitTxResult>, crate::error::RtdError>>()?;
...
fn try_from_raw_rejected_status(
    rejected: RawRejectedStatus,
) -> Result<Option<crate::error::RtdError>, crate::error::RtdError> {
...
fn try_from_response_rejected(
    error: Option<crate::error::RtdError>,
) -> Result<RawRejectedStatus, crate::error::RtdError> {
...
fn try_from_response_executed(
    ...
    details: Option<Box<ExecutedData>>,
    fast_path: bool,
) -> Result<RawExecutedStatus, crate::error::RtdError> {
...
impl TryFrom<RawWaitForEffectsRequest> for WaitForEffectsRequest {
    ...
    fn try_from(value: RawWaitForEffectsRequest) -> Result<Self, Self::Error> {
        ...
        let ping_type = value
            .ping_type
            .map(|p| {
                PingType::try_from(p).map_err(|e| RtdErrorKind::GrpcMessageDeserializeError {
...
mod tests {
    ...
    async fn test_submit_tx_request_into_raw() {
        ...
        );
        {
            ...
            let sender = crate::base_types::RtdAddress::random_for_testing_only();
            let recipient = crate::base_types::RtdAddress::random_for_testing_only();
