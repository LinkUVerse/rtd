...
pub enum ExecutionFailureStatus {
    ...
    InsufficientGas,
    #[error("Invalid Gas Object. Possibly not address-owned or possibly not a RTD coin.")]
    InvalidGasObject,
    ...
    #[error(
        ...
        Please run the Rtd Move Verifier for more information."
    )]
    RtdMoveVerificationError,
    ...
    #[error(
        "Rtd Move Bytecode Verification Timeout. \
        Please run the Rtd Move Verifier for more information."
    )]
    RtdMoveVerificationTimedout,
