...
use crate::base_types::{ObjectDigest, RtdAddress, TransactionDigest};
use crate::event::{Event, EventEnvelope};
use crate::filter::{EventFilter, Filter};
use crate::gas_coin::GasCoin;
use crate::object::OBJECT_START_VERSION;
use crate::{ObjectID, MOVE_STDLIB_ADDRESS, RTD_FRAMEWORK_ADDRESS};
...
fn test_move_event_filter() {
    ...
    let move_event = Event {
        package_id: ObjectID::from(RTD_FRAMEWORK_ADDRESS),
    ...
    let filters = vec![
        ...
        EventFilter::Package(ObjectID::from(RTD_FRAMEWORK_ADDRESS)),
...
fn test_transfer_filter() {
    ...
    let recipient = Owner::AddressOwner(RtdAddress::random_for_testing_only());
