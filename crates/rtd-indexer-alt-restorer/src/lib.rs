...
#[clap(name = "rtd-indexer-alt-restorer")]
pub struct Args {
    ...
    /// for example <https://formal-snapshot.mainnet.rtd.io>
    ...
    #[clap(
        long,
        env = "DATABASE_URL",
        default_value = "postgres://postgres:postgrespw@localhost:5432/rtd_indexer_alt"
    )]
    pub database_url: Url,

    /// Database connection arguments from `rtd-pg-db`.
    #[clap(flatten)]
    pub db_args: DbArgs,
}
