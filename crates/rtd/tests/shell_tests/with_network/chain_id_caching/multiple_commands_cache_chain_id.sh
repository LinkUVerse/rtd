...
rtd client --client.config $CONFIG objects > output.txt 2>&1
...
rtd client --client.config $CONFIG gas > output.txt 2>&1
echo "Command executed"
...
rtd client --client.config $CONFIG balance > output.txt 2>&1
echo "Command executed"
