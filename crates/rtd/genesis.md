...
This document lays out the step-by-step process for orchestrating a Rtd Genesis Ceremony.
...
- An Ed25519 key can be created using `rtd keytool generate`
...
$ rtd genesis-ceremony add-validator \
...
```
$ rtd genesis-ceremony add-gas-object \
    --address <RtdAddress> \
    --object-id <ObjectId> \
    --valud <# of rtd coins>
$ git add .
...
```
$ rtd genesis-ceremony verify-and-sign \
    --key-file <path to key file>
$ git add .
