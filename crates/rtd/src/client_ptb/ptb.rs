...
use crate::{
    client_commands::{
        GasDataArgs, RtdClientCommandResult, TxProcessingArgs, dry_run_or_execute_or_serialize,
    },
    client_ptb::{
...
pub fn ptb_description() -> clap::Command {
    clap::Command::new("rtd client ptb")
        .about(
        ...
        .long_help(
            ...
            \n --make-move-vec <rtd::coin::Coin<rtd::rtd::RTD>> [gas]"
        )
