...
use rtd_name_service::Domain;
use rtd_name_service::NameRecord;
...
use rtd_rpc::proto::rtd::rpc::v2::LookupNameRequest;
use rtd_rpc::proto::rtd::rpc::v2::LookupNameResponse;
use rtd_rpc::proto::rtd::rpc::v2::ReverseLookupNameRequest;
use rtd_rpc::proto::rtd::rpc::v2::ReverseLookupNameResponse;
use rtd_rpc::proto::rtd::rpc::v2::name_service_server::NameService;
...
fn name_service_config(service: &RpcService) -> Result<NameServiceConfig> {
    match service.chain_id.chain() {
        rtd_protocol_config::Chain::Mainnet => Ok(NameServiceConfig::mainnet()),
        rtd_protocol_config::Chain::Testnet => Ok(NameServiceConfig::testnet()),
        rtd_protocol_config::Chain::Unknown => Err(RpcError::new(
            tonic::Code::Unimplemented,
            "RtdNS not configured for this network",
        )),
    }
}
...
fn lookup_name(service: &RpcService, request: LookupNameRequest) -> Result<LookupNameResponse> {
    ...
    if is_valid {
        let mut record = rtd_rpc::proto::rtd::rpc::v2::NameRecord::default();
...
fn reverse_lookup_name(
    ...
    let domain = field_reverse_record_object
        .to_rust::<rtd_types::dynamic_field::Field<Address, Domain>>()
        .ok_or_else(|| {
            RpcError::new(
                tonic::Code::Internal,
