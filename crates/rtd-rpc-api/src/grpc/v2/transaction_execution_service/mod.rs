...
use rtd_rpc::proto::rtd::rpc::v2::ExecuteTransactionResponse;
...
use rtd_rpc::proto::rtd::rpc::v2::transaction_execution_service_server::TransactionExecutionService;
...
pub async fn execute_transaction(
    ...
    let transaction = request
        ...
        .pipe(rtd_sdk_types::Transaction::try_from)
        .map_err(|e| {
    ...
    let signatures = request
        ...
        .enumerate()
        .map(|(i, signature)| {
            rtd_sdk_types::UserSignature::try_from(signature).map_err(|e| {
    ...
    let signed_transaction = rtd_sdk_types::SignedTransaction {
