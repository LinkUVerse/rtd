...
pub fn resolve_transaction(
    ...
    let commands = ptb
        .commands
        .iter()
        .map(rtd_sdk_types::Command::try_from)
...
fn resolve_unresolved_transaction(
    ...
    reference_gas_price: u64,
    max_gas_budget: u64,
    sender: rtd_sdk_types::Address,
    unresolved_inputs: &[rtd_rpc::proto::rtd::rpc::v2::Input],
    commands: Vec<Command>,
    gas_payment: Option<&rtd_rpc::proto::rtd::rpc::v2::GasPayment>,
    expiration: Option<&rtd_rpc::proto::rtd::rpc::v2::TransactionExpiration>,
) -> Result<TransactionData> {
    ...
    let expiration = expiration
        .map(rtd_types::transaction::TransactionExpiration::try_from)
        .transpose()
        .map_err(|e| {
...
fn resolve_gas_object_reference(
    ...
    let Ok(gas_coin) = rtd_types::gas_coin::GasCoin::try_from(&object) else {
...
fn resolve_object_reference_with_object(
    ...
    match object.owner() {
        rtd_types::object::Owner::AddressOwner(_) | rtd_types::object::Owner::Immutable => {}
        _ => {
...
fn resolve_object(
    ...
    match object.owner() {
        rtd_types::object::Owner::Immutable => resolve_object_reference_with_object(
            &object,
            UnresolvedObjectReference {
                object_id,
                version,
        ...
        rtd_types::object::Owner::AddressOwner(_) => {
...
fn arg_type_of_move_call_input(
    called_packages: &NormalizedPackages,
    move_call: &rtd_sdk_types::MoveCall,
    idx: usize,
...
fn resolve_shared_input_with_object(
    ...
    let initial_shared_version = if let rtd_types::object::Owner::Shared {
    ...
    Ok(ObjectArg::SharedObject {
        ...
        mutability: if mutable {
            ...
            rtd_types::transaction::SharedObjectMutability::Immutable
        },
    })
}
...
impl TryFrom<&rtd_rpc::proto::rtd::rpc::v2::ObjectReference> for UnresolvedObjectReference {
    type Error = FieldViolation;

    fn try_from(
        value: &rtd_rpc::proto::rtd::rpc::v2::ObjectReference,
...
struct UnresolvedInput<'a> {
    pub kind: Option<rtd_rpc::proto::rtd::rpc::v2::input::InputKind>,
    pub pure: Option<&'a Bytes>,
    pub object_id: Option<rtd_sdk_types::Address>,
...
impl<'a> UnresolvedInput<'a> {
    fn from_proto(input: &'a rtd_rpc::proto::rtd::rpc::v2::Input) -> Result<Self, FieldViolation> {
        Ok(Self {
