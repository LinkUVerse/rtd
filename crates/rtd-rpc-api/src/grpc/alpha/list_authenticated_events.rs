...
use prost::Message;
use std::str::FromStr;
use rtd_rpc::proto::rtd::rpc::v2::{Bcs, Event};
...
fn to_grpc_event(ev: &rtd_types::event::Event) -> Event {
...
pub fn list_authenticated_events(
    ...
    let stream_addr = RtdAddress::from_str(&stream_id).map_err(|e| {
        RpcError::new(
            tonic::Code::InvalidArgument,
