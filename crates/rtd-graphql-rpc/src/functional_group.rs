...
pub enum FunctionalGroup {
    ...
    /// RtdNS name and reverse name look-up.
    NameService,
...
impl FunctionalGroup {
    ...
    /// Not a rtdtable `Display` implementation because it enquotes the representation.
...
fn functional_groups() -> &'static BTreeMap<(&'static str, &'static str), FunctionalGroup> {
    ...
    static GROUPS: Lazy<BTreeMap<(&str, &str), FunctionalGroup>> = Lazy::new(|| {
        BTreeMap::from_iter([
            ...
            (("Address", "defaultRtdnsName"), G::NameService),
            (("Address", "rtdnsRegistrations"), G::NameService),
            ...
            (("Query", "resolveRtdnsAddress"), G::NameService),
