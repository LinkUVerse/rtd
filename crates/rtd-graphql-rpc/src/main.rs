...
use clap::Parser;
use rtd_graphql_rpc::commands::Command;
use rtd_graphql_rpc::config::{ServerConfig, ServiceConfig, Version};
use rtd_graphql_rpc::server::graphiql_server::start_graphiql_server;
...
// VERSION mimics what other rtd binaries use for the same const
