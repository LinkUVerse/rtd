...
use async_graphql::*;
use rtd_types::base_types::ObjectRef as NativeObjectRef;

use super::{object::Object, rtd_address::RtdAddress, uint53::UInt53};
...
impl ObjectRead {
    ...
    async fn address(&self) -> RtdAddress {
        self.address_impl()
    }
...
impl ObjectRead {
    fn address_impl(&self) -> RtdAddress {
        RtdAddress::from(self.native.0)
    }
