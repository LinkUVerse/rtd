...
use async_graphql::*;
use rtd_json_rpc_types::{DevInspectResults, RtdExecutionResult};
use rtd_types::effects::TransactionEffects as NativeTransactionEffects;
use rtd_types::transaction::TransactionData as NativeTransactionData;
...
impl TryFrom<RtdExecutionResult> for DryRunEffect {
    type Error = crate::error::Error;

    fn try_from(result: RtdExecutionResult) -> Result<Self, Self::Error> {
