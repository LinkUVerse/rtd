...
use super::rtdns_registration::{DomainFormat, NameService, RtdnsRegistration};
use crate::data::Db;
...
use crate::types::rtd_address::RtdAddress;
...
#[graphql(
    name = "IOwner",
    field(name = "address", ty = "RtdAddress"),
    field(
        name = "objects",
    ...
    field(
        ...
        desc = "Total balance of all coins with marker type owned by this object or address. If \
                type is not supplied, it defaults to `0x2::rtd::RTD`."
    ),
    field(
        name = "balances",
        arg(name = "first", ty = "Option<u64>"),
    ...
    field(
        ...
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, StakedRtd>",
        desc = "The `0x3::staking_pool::StakedRtd` objects owned by this object or address."
    ),
    field(
        name = "default_rtdns_name",
    ...
    field(
        name = "rtdns_registrations",
        arg(name = "first", ty = "Option<u64>"),
        arg(name = "after", ty = "Option<object::Cursor>"),
        arg(name = "last", ty = "Option<u64>"),
        arg(name = "before", ty = "Option<object::Cursor>"),
        ty = "Connection<String, RtdnsRegistration>",
        desc = "The RtdnsRegistration NFTs owned by this object or address. These grant the owner \
...
/// An Owner is an entity that can own an object. Each Owner is identified by a RtdAddress which
...
impl Owner {
    ...
    /// supplied, it defaults to `0x2::rtd::RTD`.
    ...
    /// The `0x3::staking_pool::StakedRtd` objects owned by this object or address.
    ...
    /// The RtdnsRegistration NFTs owned by this object or address. These grant the owner the
