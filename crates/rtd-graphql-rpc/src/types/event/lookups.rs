...
fn select_ev(sender: Option<RtdAddress>, from: &str) -> RawQuery {
...
pub(crate) fn select_sender(sender: RtdAddress) -> RawQuery {
    select_ev(Some(sender), "event_senders")
}

pub(crate) fn select_event_type(event_type: &TypeFilter, sender: Option<RtdAddress>) -> RawQuery {
    match event_type {
