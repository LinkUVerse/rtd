...
use rtd_types::authenticator_state::{ActiveJwk, AuthenticatorStateInner};
...
pub(crate) async fn verify_zklogin_signature(
    ...
    let df = DynamicField::query(
        ctx,
        RTD_AUTHENTICATOR_STATE_ADDRESS.into(),
        None,
        DynamicFieldName {
