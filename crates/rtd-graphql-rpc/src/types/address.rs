...
use super::{
    ...
    rtdns_registration::{DomainFormat, RtdnsRegistration},
...
impl Address {
    ...
    /// The `0x3::staking_pool::StakedRtd` objects owned by this address.
    ...
    /// The RtdnsRegistration NFTs owned by this address. These grant the owner the capability to
