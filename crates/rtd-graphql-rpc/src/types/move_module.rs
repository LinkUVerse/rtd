...
use rtd_types::move_package;

use crate::consistency::{ConsistentIndexCursor, ConsistentNamedCursor};
use crate::error::Error;
use rtd_package_resolver::Module as ParsedMoveModule;
...
use super::{base64::Base64, move_package::MovePackage, rtd_address::RtdAddress};

#[derive(Clone)]
pub(crate) struct MoveModule {
    pub storage_id: RtdAddress,
    pub native: Vec<u8>,
