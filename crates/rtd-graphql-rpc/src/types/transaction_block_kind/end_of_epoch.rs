...
use rtd_types::digests::ChainIdentifier as RtdChainIdentifier;
use rtd_types::{
...
impl ChangeEpochTransaction {
    ...
    /// The RTD returned to transaction senders for cleaning up objects (in MIST).
    ...
    async fn system_packages(
        ...
        for c in cs {
            ...
            let object = Object::from_native(RtdAddress::from(runtime_id), native, c.c, None);
