...
use rtd_json_rpc_types::RtdArgument;
...
impl MoveCallTransaction {
    ...
    async fn package(&self) -> RtdAddress {
    ...
    fn from(pt: NativeProgrammableTransaction, checkpoint_viewed_at: u64) -> Self {
        ...
        match pt {
            ...
            N::Publish(modules, dependencies) => P::Publish(PublishTransaction {
                ...
                dependencies: dependencies.into_iter().map(RtdAddress::from).collect(),
            }),
...
impl From<RtdArgument> for TransactionArgument {
    fn from(argument: RtdArgument) -> Self {
        use RtdArgument as S;
        use TransactionArgument as A;
        match argument {
