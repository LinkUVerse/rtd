...
use async_graphql::*;
use rtd_types::rtd_system_state::rtd_system_state_summary::RtdSystemStateSummary as NativeSystemStateSummary;
...
impl SystemStateSummary {
    ...
    /// The value of the `version` field of `0x5`, the `0x3::rtd::RtdSystemState` object.  This
