...
use std::sync::Arc;
use rtd_bridge::abi::EthRtdBridge;
use rtd_bridge::metered_eth_provider::MeteredEthHttpProvier;
use tokio::time::Duration;
use tracing::{error, info};

pub struct EthBridgeStatus {
    bridge_contract: EthRtdBridge<Provider<MeteredEthHttpProvier>>,
    metric: IntGauge,
}
...
impl EthBridgeStatus {
    pub fn new(
        ...
        let bridge_contract = EthRtdBridge::new(bridge_address, provider.clone());
        Self {
            bridge_contract,
            metric,
        }
