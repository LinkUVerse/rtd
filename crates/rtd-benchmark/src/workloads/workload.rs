...
pub const MAX_GAS_FOR_TESTING: u64 = 1_000 * MIST_PER_RTD;

// TODO: get this information from protocol config
// This is the maximum budget that can be set for a transaction. 50 RTD.
pub const MAX_BUDGET: u64 = 50 * MIST_PER_RTD;
