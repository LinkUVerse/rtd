...
use rtd_pg_db::{Db, DbArgs};
use rtd_test_transaction_builder::TestTransactionBuilder;
use rtd_types::{full_checkpoint_content::Checkpoint, transaction::TransactionDataAPI};
...
impl concurrent::Handler for TxCounts {
    ...
    async fn commit<'a>(
        ...
        conn: &mut rtd_pg_db::Connection<'a>,
    ) -> anyhow::Result<usize> {
...
async fn transfer_coin(
    wallet: &mut rtd_sdk::wallet_context::WalletContext,
) -> rtd_types::base_types::TransactionDigest {
