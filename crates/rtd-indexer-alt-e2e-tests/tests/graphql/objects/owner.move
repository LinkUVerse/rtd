...
//> 0: rtd::bag::add<u64, u64>(Input(0), Input(1), Input(1))
...
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: rtd::transfer::public_freeze_object<rtd::coin::Coin<rtd::rtd::RTD>>(Result(0));

//# programmable --sender A --inputs 4000 @A
//> 0: SplitCoins(Gas, [Input(0)]);
//> 1: rtd::party::single_owner(Input(1));
//> 2: rtd::transfer::public_party_transfer<rtd::coin::Coin<rtd::rtd::RTD>>(Result(0), Result(1));
