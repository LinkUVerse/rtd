...
//> 1: rtd::object::id_address<rtd::coin::Coin<rtd::rtd::RTD>>(Gas);
...
//> 1: rtd::object::id_address<rtd::coin::Coin<rtd::rtd::RTD>>(NestedResult(0,0));
//> 2: TransferObjects([NestedResult(0,1)], Result(1));
//> 3: rtd::object::id_address<rtd::coin::Coin<rtd::rtd::RTD>>(Gas);
...
{ # ... and for balance point-lookups
  object(address: "@{obj_0_0}", version: 2) {
    balance(coinType: "0x2::rtd::RTD") { totalBalance }
  }
}
...
{ # ... and balance multi-gets
  object(address: "@{obj_0_0}", version: 2) {
    multiGetBalances(keys: ["0x2::rtd::RTD"]) { totalBalance }
  }
}
...
fragment Owned on IAddressable {
  ...
  rtd: balance(coinType: "0x2::rtd::RTD") { totalBalance }
