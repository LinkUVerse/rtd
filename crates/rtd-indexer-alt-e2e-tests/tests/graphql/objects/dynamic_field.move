...
//> rtd::bag::add<u64, u64>(Input(0), Input(1), Input(2))

//# create-checkpoint

//# programmable --sender A --inputs object(1,0) 43 object(3,0)
//> rtd::bag::add<u64, rtd::coin::Coin<rtd::rtd::RTD>>(Input(0), Input(1), Input(2))

//# programmable --sender A --inputs object(2,0) 44 object(4,0)
//> rtd::object_bag::add<u64, rtd::coin::Coin<rtd::rtd::RTD>>(Input(0), Input(1), Input(2))
