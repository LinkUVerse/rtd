...
use rtd_indexer_alt::{BootstrapGenesis, config::IndexerConfig, setup_indexer};
...
use rtd_types::full_checkpoint_content::{Checkpoint, CheckpointData};
use rtd_types::{
...
impl FullCluster {
    ...
    pub fn funded_account(
        &mut self,
        amount: u64,
    ) -> anyhow::Result<(RtdAddress, AccountKeyPair, ObjectRef)> {
