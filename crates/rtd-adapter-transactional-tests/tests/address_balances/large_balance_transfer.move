...
//# programmable --sender A --inputs withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
...
//# programmable --sender A --inputs withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551615) @B
//> 0: rtd::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
