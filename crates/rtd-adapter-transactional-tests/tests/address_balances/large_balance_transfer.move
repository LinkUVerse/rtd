...
//# programmable --sender A --inputs withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) @B
//> 0: rtd::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: rtd::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(1));
...
//# programmable --sender A --inputs withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) withdraw<rtd::balance::Balance<test::large_balance::MARKER>>(18446744073709551614) @B
//> 0: rtd::balance::redeem_funds<test::large_balance::MARKER>(Input(0));
//> 1: rtd::balance::redeem_funds<test::large_balance::MARKER>(Input(1));
//> 2: rtd::balance::join<test::large_balance::MARKER>(Result(0), Result(1));
//> 3: rtd::balance::send_funds<test::large_balance::MARKER>(Result(0), Input(2));
