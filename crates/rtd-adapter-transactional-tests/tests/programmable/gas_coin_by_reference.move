...
//# programmable --sender A
//> test::m1::t2<rtd::coin::Coin<rtd::rtd::RTD>>(Gas)

//# programmable --sender A
//> test::m1::t2<rtd::coin::Coin<rtd::rtd::RTD>>(Gas)

//# programmable --sender A
//> test::m1::t4<rtd::coin::Coin<rtd::rtd::RTD>>(Gas)

//# programmable --sender A
//> test::m1::t5<rtd::coin::Coin<rtd::rtd::RTD>>(Gas)

//# programmable --sender A
//> test::m1::t6<rtd::coin::Coin<rtd::rtd::RTD>>(Gas)
