...
//> 0: test::m1::name();
//> 1: rtd::coin_registry::new_currency<rtd::kiosk::Kiosk>(Input(0), Input(2), Result(0), Result(0), Result(0), Result(0));
//> 2: rtd::coin_registry::finalize<rtd::kiosk::Kiosk>(NestedResult(1,0));
