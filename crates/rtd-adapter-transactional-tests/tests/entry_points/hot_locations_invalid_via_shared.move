...
public fun share(ctx: &mut TxContext) {
    rtd::transfer::share_object(Shared { id: object::new(ctx) })
}
...
entry fun play_coin(_: &Coin<RTD>) {}
entry fun play_u64(_: u64) {}
entry fun play_receiving(_: rtd::transfer::Receiving<A>) {}
...
//> test::m::a();
//> rtd::transfer::public_transfer<test::m::A>(Result(0), Input(0));
...
// gas coin by-ref
//> test::m::heat_imm<rtd::coin::Coin<rtd::rtd::RTD>>(Gas, Input(0));
//> test::m::play_coin(Gas);

//# programmable --sender A --inputs object(5,0)
// gas coin by-mut
//> test::m::heat_mut<rtd::coin::Coin<rtd::rtd::RTD>>(Gas, Input(0));
//> test::m::play_coin(Gas);
...
//> 0: test::m::heat_imm<rtd::transfer::Receiving<test::m::A>>(Input(0), Input(1));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0) object(5,0)
// receiving input by-mut
//> 0: test::m::heat_mut<rtd::transfer::Receiving<test::m::A>>(Input(0), Input(1));
//> test::m::play_receiving(Input(0));

//# programmable --sender A --inputs receiving(4,0) object(5,0)
// receiving input by-val
//> 0: test::m::heat_val<rtd::transfer::Receiving<test::m::A>>(Input(0), Input(1));
