...
module t2::o2 {
    ...
    public fun pop_coin(mut o2: vector<Coin<RTD>>): Coin<RTD> {
    ...
    public fun share_coin(o2: Coin<RTD>) {
...
//> 2: SplitCoins(Result(1), [Input(0)]);
//> 3: TransferObjects([Result(2)], Input(2));
//> 4: rtd::transfer::public_share_object<rtd::coin::Coin<rtd::rtd::RTD>>(Input(1));
