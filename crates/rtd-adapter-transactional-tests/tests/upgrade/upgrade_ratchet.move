...
//# run rtd::package::only_additive_upgrades --args object(1,1) --sender A
...
//# run rtd::package::only_dep_upgrades --args object(1,1) --sender A
...
//# run rtd::package::make_immutable --args object(1,1) --sender A
