...
//> 0: rtd::coin::mint<ex::m::M>(Input(0), Input(1));
//> 1: rtd::coin::mint<ex::m::M>(Input(0), Input(1));
//> 2: TransferObjects([Result(0)], Input(2));
//> 3: rtd::party::single_owner(Input(2));
//> rtd::transfer::public_party_transfer<rtd::coin::Coin<ex::m::M>>(Result(1), Result(3))
