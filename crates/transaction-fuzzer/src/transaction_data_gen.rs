...
pub fn gen_gas_data(sender: RtdAddress) -> impl Strategy<Value = GasData> {
    (
...
pub fn transaction_data_gen(sender: RtdAddress) -> impl Strategy<Value = TransactionData> {
...
{
    pub fn new(sender: RtdAddress) -> Self {
        Self {
            kind: None,
            sender,
            gas_data: None,
