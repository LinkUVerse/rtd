...
impl MetricsPushClient {
    pub fn new(metrics_key: rtd_types::crypto::NetworkKeyPair) -> Self {
        use fastcrypto::traits::KeyPair;
        let certificate = std::sync::Arc::new(rtd_tls::SelfSignedCertificate::new(
            metrics_key.private(),
            rtd_tls::RTD_VALIDATOR_SERVER_NAME,
        ));
