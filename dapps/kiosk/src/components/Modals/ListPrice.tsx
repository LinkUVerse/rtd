...
import { MIST_PER_RTD } from '@linku/rtd/utils';
					...
					<Button
						...
						onClick={() =>
							placeAndListToKioskMutation.mutate({
								item,
								price: (Number(price) * Number(MIST_PER_RTD)).toString(),
