...
const _: () = {
    ...
    assert!(BinaryFlavor::mask_and_shift_to_unflavor(x) == BinaryFlavor::RTD_FLAVOR);
};
...
impl BinaryFlavor {
    ...
    // The Rtd flavor is 0x05
    pub const RTD_FLAVOR: u8 = 0x05;
    ...
    const fn shift_and_flavor(unflavored: u32) -> u32 {
        ((Self::RTD_FLAVOR as u32) << Self::SHIFT_AMOUNT) | unflavored
    }
}
