...
module a::m {
    ...
    public fun m<T: store>(s: other::S<T>, p: rtd::party::Party) {
        transfer::public_party_transfer(s, p)
    }

    public fun m_gen<T: key + store>(s: T, p: rtd::party::Party) {
        transfer::public_party_transfer(s, p)
    }
}
...
module rtd::transfer {
    ...
    public fun party_transfer<T: key>(_: T, _: rtd::party::Party) {
        abort 0
    }

    public fun public_party_transfer<T: key + store>(_: T, _: rtd::party::Party) {
        abort 0
    }
