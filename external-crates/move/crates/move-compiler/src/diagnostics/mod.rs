...
pub const ICE_BUG_REPORT_MESSAGE: &str = "The Move compiler has encountered an internal compiler error.\n \
    Please report this issue to the LinkU Labs Move language team,\n \
    including this error and any relevant code, to the LinkU Labs issue tracker\n \
    at : https://github.com/LinkUVerse/rtd/issues";
