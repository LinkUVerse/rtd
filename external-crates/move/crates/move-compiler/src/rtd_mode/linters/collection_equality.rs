...
//! This analysis flags situations when instances of a rtd::table::Table or rtd::table_vec::TableVec
//! or rtd::bag::Bag are being compared for (in)equality at this type of comparison is not very
...
use crate::{
    ...
    parser::ast as P,
    rtd_mode::{RTD_ADDR_NAME, RTD_ADDR_VALUE},
...
const COLLECTION_TYPES: &[(Symbol, AccountAddress, &str, &str)] = &[
    (RTD_ADDR_NAME, RTD_ADDR_VALUE, BAG_MOD_NAME, BAG_STRUCT_NAME),
    (
        RTD_ADDR_NAME,
        RTD_ADDR_VALUE,
        OBJECT_BAG_MOD_NAME,
