...
use crate::{
    ...
    parser::ast::Ability_,
    rtd_mode::{RTD_ADDR_VALUE, TX_CONTEXT_MODULE_NAME},
};
...
const TRANSFER_FUNCTIONS: &[(AccountAddress, &str, &str)] = &[
    (RTD_ADDR_VALUE, TRANSFER_MOD_NAME, PUBLIC_TRANSFER_FUN),
    (RTD_ADDR_VALUE, TRANSFER_MOD_NAME, TRANSFER_FUN),
];
...
impl SimpleAbsInt for SelfTransferVerifierAI {
    ...
    fn call_custom(
        ...
        if f.is(&RTD_ADDR_VALUE, TX_CONTEXT_MODULE_NAME, "sender") {
