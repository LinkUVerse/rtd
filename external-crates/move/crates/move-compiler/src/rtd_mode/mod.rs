...
pub const RTD_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x2);
pub const RTD_SYSTEM_ADDR_VALUE: AccountAddress = AccountAddress::from_suffix(0x3);
...
pub const RTD_ADDR_NAME: Symbol = symbol!("rtd");
...
pub const RTD_MODULE_NAME: Symbol = symbol!("rtd");
pub const RTD_OTW_NAME: Symbol = symbol!("RTD");

pub const RTD_SYSTEM_ADDR_NAME: Symbol = symbol!("rtd_system");
pub const RTD_SYSTEM_MODULE_NAME: Symbol = symbol!("rtd_system");
pub const RTD_SYSTEM_CREATE: Symbol = symbol!("create");
pub const CLOCK_MODULE_NAME: Symbol = symbol!("clock");
pub const CLOCK_TYPE_NAME: Symbol = symbol!("Clock");
pub const RTD_CLOCK_CREATE: Symbol = symbol!("create");
