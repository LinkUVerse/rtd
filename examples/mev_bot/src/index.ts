...
import { bcs, BcsType } from '@linku/rtd/bcs';
...
const client = new RtdClient({ url: 'https://rtd-mainnet.linkulabs.com/json-rpc' });
...
console.log(`Total estimated storage fee rebate: ${rebate / 1e9} RTD`);
