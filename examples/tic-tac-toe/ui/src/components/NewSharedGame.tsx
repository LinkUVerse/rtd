    ...
    return (
        <>
            ...
            <Flex justify="between" mt="4">
                ...
                <Button
                    variant="outline"
                    disabled={!(player && opponent) || isPending}
                    onClick={onClick}
                >
            ...
            <Em>
                <Text as="div">
                    Create the game as a shared object that both players can access. Each move is a
                    single transaction, but it requires going through consensus.
                </Text>
            </Em>
        </>
    );
