...
mod checked {
    use crate::{
        ...
        data_store::{
            ...
            legacy::{linkage_view::LinkageView, rtd_data_store::RtdDataStore},
        },
    ...
    pub struct ExecutionContext<'vm, 'state, 'a> {
        ...
        additional_transfers: Vec<(/* new owner */ RtdAddress, ObjectValue)>,
    ...
    impl<'vm, 'state, 'a> ExecutionContext<'vm, 'state, 'a> {
        ...
        pub(crate) fn execute_function_bypass_visibility(
            ...
            let mut data_store = RtdDataStore::new(&self.linkage_view, &self.new_packages);
    ...
    pub fn finish(
        ...
        settlement_input_rtd: u64,
        settlement_output_rtd: u64,
    ...
    pub fn load_type_from_struct(
        ...
        let data_store = RtdDataStore::new(linkage_view, new_packages);
        ...
        Ok(match call_arg {
            ...
            CallArg::FundsWithdrawal(FundsWithdrawalArg {
                ...
                let limit = match reservation {
                    rtd_types::transaction::Reservation::EntireBalance => {
                        // TODO(address-balances): support entire balance withdrawal
                        todo!("Entire balance withdrawal not yet supported")
                    }
                    rtd_types::transaction::Reservation::MaxAmountU64(u) => U256::from(u),
                };
    ...
    fn convert_vm_error<S: MoveResolver<Err = RtdError>>(
        error: VMError,
        vm: &MoveVM,
        state_view: &S,
    ...
    /// Special case errors for type arguments to Move functions
    fn convert_type_argument_error<S: MoveResolver<Err = RtdError>>(
        idx: usize,
        error: VMError,
        vm: &MoveVM,
        state_view: &S,
        ...
        use rtd_types::execution_status::TypeArgumentError;
