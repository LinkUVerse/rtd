...
pub fn all_natives(silent: bool, protocol_config: &ProtocolConfig) -> NativeFunctionTable {
    let rtd_framework_natives: &[(&str, &str, NativeFunction)] = &[
        (
            "accumulator",
            "emit_deposit_event",
        ...
        (
            ...
            "record_settlement_rtd_conservation",
            make_native!(accumulator::record_settlement_rtd_conservation),
        ),
    ...
    let rtd_system_natives: &[(&str, &str, NativeFunction)] = &[(
        "validator",
        ...
        _ => {
            return Err(
                PartialVMError::new(StatusCode::UNKNOWN_INVARIANT_VIOLATION_ERROR)
                    .with_message("Rtd verifier guarantees this is a struct".to_string()),
            );
        }
    };
