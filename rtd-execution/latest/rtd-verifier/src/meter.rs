...
struct RtdVerifierMeterBounds {
    name: String,
    ticks: u128,
    max_ticks: Option<u128>,
}

impl RtdVerifierMeterBounds {
...
pub struct RtdVerifierMeter {
    transaction_bounds: RtdVerifierMeterBounds,
    package_bounds: RtdVerifierMeterBounds,
    module_bounds: RtdVerifierMeterBounds,
    function_bounds: RtdVerifierMeterBounds,
}

impl RtdVerifierMeter {
    ...
    fn get_bounds_mut(&mut self, scope: Scope) -> &mut RtdVerifierMeterBounds {
        match scope {
    ...
    fn get_bounds(&self, scope: Scope) -> &RtdVerifierMeterBounds {
        match scope {
...
impl Meter for RtdVerifierMeter {
