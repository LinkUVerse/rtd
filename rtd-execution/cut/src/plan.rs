...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let rtd_execution = root.join("rtd-execution");
        ...
        // Other examples
        assert!(ws.members.contains(&rtd_execution));
    ...
    fn test_no_workspace() {
        ...
        expect!["No [workspace] found at $PATH/rtd-execution/cut/Cargo.toml/Cargo.toml"]
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            packages: vec![
                ...
                "rtd-adapter-latest".to_string(),
                "rtd-execution-cut".to_string(),
                "rtd-verifier-latest".to_string(),
            ],
        })
        .unwrap();
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/rtd-execution/cut-cut",
                    "$PATH/rtd-execution/cut-move-core-types",
                    "$PATH/rtd-execution/exec-cut",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/rtd-execution/cut-move-core-types",
                        ws_state: Exclude,
                    },
                    "rtd-adapter-latest": CutPackage {
                        dst_name: "rtd-adapter-feature",
                        src_path: "$PATH/rtd-execution/latest/rtd-adapter",
                        dst_path: "$PATH/rtd-execution/exec-cut/rtd-adapter",
                        ws_state: Member,
                    },
                    "rtd-execution-cut": CutPackage {
                        dst_name: "rtd-execution-cut-feature",
                        src_path: "$PATH/rtd-execution/cut",
                        dst_path: "$PATH/rtd-execution/cut-cut",
                        ws_state: Member,
                    },
                    "rtd-verifier-latest": CutPackage {
                        dst_name: "rtd-verifier-feature",
                        src_path: "$PATH/rtd-execution/latest/rtd-verifier",
                        dst_path: "$PATH/rtd-execution/exec-cut/rtd-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
        ...
        expect![[r#"
            ...
            new [workspace] members:
             - to:   rtd-adapter-feature
                     rtd-execution/exec-cut/rtd-adapter
               from: rtd-adapter-latest
                     rtd-execution/latest/rtd-adapter
             - to:   rtd-execution-cut-feature
                     rtd-execution/cut-cut
               from: rtd-execution-cut
                     rtd-execution/cut
             - to:   rtd-verifier-feature
                     rtd-execution/exec-cut/rtd-verifier
               from: rtd-verifier-latest
                     rtd-execution/latest/rtd-verifier

            new [workspace] excludes:
             - to:   move-core-types-feature
                     rtd-execution/cut-move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        expect![[r#"
            CutPlan {
                root: "$PATH",
                directories: {
                    "$PATH/rtd-execution/feature",
                },
                packages: {
                    "move-core-types": CutPackage {
                        dst_name: "move-core-types-feature",
                        src_path: "$PATH/external-crates/move/crates/move-core-types",
                        dst_path: "$PATH/rtd-execution/feature/move/crates/move-core-types",
                        ws_state: Exclude,
                    },
                    "rtd-adapter-latest": CutPackage {
                        dst_name: "rtd-adapter-feature",
                        src_path: "$PATH/rtd-execution/latest/rtd-adapter",
                        dst_path: "$PATH/rtd-execution/feature/rtd-adapter",
                        ws_state: Member,
                    },
                    "rtd-execution-cut": CutPackage {
                        dst_name: "rtd-execution-cut-feature",
                        src_path: "$PATH/rtd-execution/cut",
                        dst_path: "$PATH/rtd-execution/feature/cut",
                        ws_state: Member,
                    },
                    "rtd-verifier-latest": CutPackage {
                        dst_name: "rtd-verifier-feature",
                        src_path: "$PATH/rtd-execution/latest/rtd-verifier",
                        dst_path: "$PATH/rtd-execution/feature/rtd-verifier",
                        ws_state: Member,
                    },
                },
            }"#]]
