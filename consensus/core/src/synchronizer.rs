...
mod tests {
    ...
    #[tokio::test]
    async fn test_process_fetched_blocks_updates_peer_round_tracker() {
        // GIVEN
        let (context, _) = Context::new_for_test(4);
        let context = Arc::new(context);
        let block_verifier = Arc::new(NoopBlockVerifier {});
        ...
        // - Authorities 1 and 2 accept the authority 0 block, reaching quorum with authority 0.
        ...
        // Synced blocks carry quorum evidence that our round 60 block was accepted.
        assert_eq!(round_tracker.read().calculate_propagation_delay(60), 0);
    }
}
