...
# GraphQL
### Containers
**graphql** - container running rtd-graphql rpc endpoint. Requires a Database updated by the indexer-writer.
...
# Indexer-Reader
### Containers
**indexer-reader** - rtd-indexer-reader jsonrpc endpoint. This offers backwards compatibility with current rtd-node json rpc. This deployment is only needed as we transition to the graphql service. This is not needed if you do not want to support the jsonrpc.
...
# Indexer-Writer
### Containers
**rtd-indexer-writer** - Indexer writer syncs and indexes rtd checkpoint data into a Postgres database. Checkpoint data can be pulled from a fullnode or a cloud provider hosted bucket. More info and available buckets can be found in rtd [doc site](https://docs.rtd.io/guides/developer/advanced/custom-indexer#remote-reader).
