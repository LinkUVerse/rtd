# Configure a Linux system as a Rtd Node using Ansible

This is a self contained Ansible role for configuring a Linux system as a Rtd Node.
...
`ansible-playbook -i inventory.yaml rtd-node.yaml -e host=$inventory_name`
