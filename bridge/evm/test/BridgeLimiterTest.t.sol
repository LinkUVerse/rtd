...
contract BridgeLimiterTest is BridgeBaseTest {
    ...
    function testMultipleChainLimits() public {
        ...
        _supportedTokens[0] = address(0); // RTD
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (address(committee), chainID, _supportedTokens, tokenPrices, tokenIds, rtdDecimals, supportedChains)
            ),
            opts
        );
    ...
    function testUpdateLimitRegressionTest() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                BridgeConfig.initialize,
                (address(committee), chainID, supportedTokens, tokenPrices, tokenIds, rtdDecimals, _supportedChains)
            ),
            opts
        );
