...
contract CommitteeUpgradeableTest is BridgeBaseTest {
    ...
    function setUp() public {
        ...
        address _config = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(
                ...
                (_committee, _chainID, supportedTokens, tokenPrices, tokenIds, rtdDecimals, _supportedDestinationChains)
            ),
            opts
        );
        ...
        address _bridge = Upgrades.deployUUPSProxy(
            "RtdBridge.sol",
            abi.encodeCall(RtdBridge.initialize, (_committee, address(0), address(0))),
            opts
        );

        bridge = RtdBridge(_bridge);
        bridgeV2 = new MockRtdBridgeV2();
    }

    function testUpgradeWithSignaturesSuccess() public {
        bytes memory initializer = abi.encodeCall(MockRtdBridgeV2.initializeV2, ());
    ...
    function testUpgradeRegressionTestWith1CalldataArg() public {
        ...
        MockRtdBridgeV2 newBridgeV2 = MockRtdBridgeV2(address(bridge));
    ...
    function testUpgradeRegressionTestWithNoCalldata() public {
        ...
        MockRtdBridgeV2(address(bridge));
        assertEq(Upgrades.getImplementationAddress(address(bridge)), address(bridgeV2));
    }
}
