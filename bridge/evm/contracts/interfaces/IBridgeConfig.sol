...
interface IBridgeConfig {
    ...
    function tokenRtdDecimalOf(uint8 tokenID) external view returns (uint8);
    ...
    /// @param rtdDecimals The added token's decimal places on Rtd.
    ...
    event TokenAdded(uint8 tokenID, address tokenAddress, uint8 rtdDecimal, uint64 tokenPrice);
