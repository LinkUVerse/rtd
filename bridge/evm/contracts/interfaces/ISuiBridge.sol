...
/// @title IRtdBridge
/// @dev Interface for the Rtd Bridge contract.
interface IRtdBridge {
    ...
    /// @param rtdAdjustedAmount The amount of tokens to transfer, adjusted for Rtd decimals.
